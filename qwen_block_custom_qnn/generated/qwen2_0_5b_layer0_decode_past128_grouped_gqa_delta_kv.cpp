...
static ModelError_t addNode_past_value_nchw(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;

  /* ADDING NODE FOR past_value_nchw */
  uint32_t dimensions_past_value_nchw_perm[] = {4};
  uint32_t past_value_nchw_perm[] = {0, 3, 1, 2};
  Qnn_Param_t params_past_value_nchw[] = {
    {.paramType=QNN_PARAMTYPE_TENSOR,
     .name="perm",
     {.tensorParam=(Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            ...
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000000000000000000000000000f, .offset= 0}}},
            .rank= 1,
            .dimensions=dimensions_past_value_nchw_perm,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=(uint8_t*)past_value_nchw_perm,
                           .dataSize=16}},
            .isDynamicDimensions= nullptr,
            .sparseParams= { QNN_SPARSE_LAYOUT_UNDEFINED,
                             .hybridCoo= {.numSpecifiedElements= 0, .numSparseDimensions= 0}},
  ...
  const char*  inputs_past_value_nchw[] = {
    "past_value"
  };
  uint32_t dimensions_past_value_nchw[] = {1, 2, 128, 64};
  Qnn_Tensor_t outputs_past_value_nchw[] = {
    (Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
            .name= "past_value_nchw",
            .type= QNN_TENSOR_TYPE_NATIVE,
            .dataFormat= QNN_TENSOR_DATA_FORMAT_DENSE,
            .dataType= QNN_DATATYPE_FLOAT_32,
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000000000000000000000000000f, .offset= 0}}},
            .rank= 4,
            .dimensions=dimensions_past_value_nchw,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=nullptr,
                           .dataSize=0}},
            .isDynamicDimensions= nullptr,
  ...
  VALIDATE(model.addNode(QNN_OPCONFIG_VERSION_1, // Op_Config_t Version
                         "past_value_nchw", // Node Name
                         "qti.aisw", // Package Name
                         "Transpose", // Qnn Node Type
                         params_past_value_nchw, // Node Params
                         1, // Num Node Params
                         inputs_past_value_nchw, // Input Tensor Names
                         1, // Num Input Tensor Names
                         outputs_past_value_nchw, // Output Tensors 
                         1// Num Output Tensors 
  ), err);
  return err;
}
  ...
  VALIDATE(model.addTensor("onnx__MatMul_227", // Tensor Name
                           (Qnn_Tensor_t) {
                               ...
                               {.v2= {
                                 ...
                                 .memType= QNN_TENSORMEMTYPE_RAW,
                                 {.clientBuf= { .data=BINVARSTART(onnx__MatMul_227),
                                                .dataSize=BINLEN(onnx__MatMul_227)}},
                                 .isDynamicDimensions= nullptr,
                                 .sparseParams= { QNN_SPARSE_LAYOUT_UNDEFINED,
                                                  .hybridCoo= {.numSpecifiedElements= 0, .numSparseDimensions= 0}},
                                 .isProduced= 0}}}
...
static ModelError_t addNode__Transpose_2(QnnModel& model){
  ...
  uint32_t dimensions_current_value[] = {1, 2, 1, 64};
...
static ModelError_t addTensor_onnx__Mul_253(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;
  uint32_t dimensions_onnx__Mul_253[] = {1, 1, 1, 32};
...
static ModelError_t addTensor_onnx__Mul_254(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;
  uint32_t dimensions_onnx__Mul_254[] = {1, 1, 1, 32};
...
static ModelError_t addNode_current_key_nhwc(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;

  /* ADDING NODE FOR current_key_nhwc */
  uint32_t dimensions_current_key_nhwc_perm[] = {4};
  uint32_t current_key_nhwc_perm[] = {0, 2, 3, 1};
  Qnn_Param_t params_current_key_nhwc[] = {
    {.paramType=QNN_PARAMTYPE_TENSOR,
     .name="perm",
     {.tensorParam=(Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            ...
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000000000000000000000000000f, .offset= 0}}},
            .rank= 1,
            .dimensions=dimensions_current_key_nhwc_perm,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=(uint8_t*)current_key_nhwc_perm,
                           .dataSize=16}},
            .isDynamicDimensions= nullptr,
            .sparseParams= { QNN_SPARSE_LAYOUT_UNDEFINED,
                             .hybridCoo= {.numSpecifiedElements= 0, .numSparseDimensions= 0}},
  ...
  const char*  inputs_current_key_nhwc[] = {
    "current_key"
  };
  uint32_t dimensions_current_key_nhwc[] = {1, 1, 64, 2};
  Qnn_Tensor_t outputs_current_key_nhwc[] = {
    (Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
            .name= "current_key_nhwc",
            .type= QNN_TENSOR_TYPE_NATIVE,
            .dataFormat= QNN_TENSOR_DATA_FORMAT_DENSE,
            .dataType= QNN_DATATYPE_FLOAT_32,
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000000000000000000000000000f, .offset= 0}}},
            .rank= 4,
            .dimensions=dimensions_current_key_nhwc,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=nullptr,
                           .dataSize=0}},
            .isDynamicDimensions= nullptr,
  ...
  VALIDATE(model.addNode(QNN_OPCONFIG_VERSION_1, // Op_Config_t Version
                         "current_key_nhwc", // Node Name
                         "qti.aisw", // Package Name
                         "Transpose", // Qnn Node Type
                         params_current_key_nhwc, // Node Params
                         1, // Num Node Params
                         inputs_current_key_nhwc, // Input Tensor Names
                         1, // Num Input Tensor Names
                         outputs_current_key_nhwc, // Output Tensors 
                         1// Num Output Tensors 
  ), err);
  return err;
}
...
static ModelError_t addTensor_onnx__Add_269(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;
  uint32_t dimensions_onnx__Add_269[] = {1, 1, 1, 1, 129};
  VALIDATE(model.addTensor("onnx__Add_269", // Tensor Name
                           (Qnn_Tensor_t) {
                               .version= QNN_TENSOR_VERSION_2,
                               {.v2= {
                                 .id=0,
                                 ...
                                 .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                                                    ...
                                                    {.scaleOffsetEncoding= {.scale= 0.0000000000000000000000000000000000000000f, .offset= 0}}},
                                 .rank= 5,
                                 .dimensions=dimensions_onnx__Add_269,
                                 .memType= QNN_TENSORMEMTYPE_RAW,
                                 {.clientBuf= { .data=BINVARSTART(onnx__Add_269),
                                                .dataSize=BINLEN(onnx__Add_269)}},
                                 .isDynamicDimensions= nullptr,
                                 .sparseParams= { QNN_SPARSE_LAYOUT_UNDEFINED,
                                                  .hybridCoo= {.numSpecifiedElements= 0, .numSparseDimensions= 0}},
                                 .isProduced= 0}}}
...
static ModelError_t addTensor_onnx__MatMul_279(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;
  uint32_t dimensions_onnx__MatMul_279[] = {896, 896};
  VALIDATE(model.addTensor("onnx__MatMul_279", // Tensor Name
                           (Qnn_Tensor_t) {
                               .version= QNN_TENSOR_VERSION_2,
                               {.v2= {
                                 .id=0,
                                 .name= "onnx__MatMul_279",
                                 .type= QNN_TENSOR_TYPE_STATIC,
                                 .dataFormat= QNN_TENSOR_DATA_FORMAT_DENSE,
                                 .dataType= QNN_DATATYPE_FLOAT_32,
                                 .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                                                    ...
                                                    {.scaleOffsetEncoding= {.scale= 0.0000000000000000000000000000000000000000f, .offset= 0}}},
                                 .rank= 2,
                                 .dimensions=dimensions_onnx__MatMul_279,
                                 .memType= QNN_TENSORMEMTYPE_RAW,
                                 {.clientBuf= { .data=BINVARSTART(onnx__MatMul_279),
                                                .dataSize=BINLEN(onnx__MatMul_279)}},
                                 .isDynamicDimensions= nullptr,
                                 .sparseParams= { QNN_SPARSE_LAYOUT_UNDEFINED,
                                                  .hybridCoo= {.numSpecifiedElements= 0, .numSparseDimensions= 0}},
                                 .isProduced= 0}}}
...
static ModelError_t addTensor_onnx__MatMul_280(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;
  uint32_t dimensions_onnx__MatMul_280[] = {4864, 896};
  VALIDATE(model.addTensor("onnx__MatMul_280", // Tensor Name
                           (Qnn_Tensor_t) {
                               .version= QNN_TENSOR_VERSION_2,
                               {.v2= {
                                 .id=0,
                                 .name= "onnx__MatMul_280",
                                 .type= QNN_TENSOR_TYPE_STATIC,
                                 .dataFormat= QNN_TENSOR_DATA_FORMAT_DENSE,
                                 .dataType= QNN_DATATYPE_FLOAT_32,
                                 .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                                                    ...
                                                    {.scaleOffsetEncoding= {.scale= 0.0000000000000000000000000000000000000000f, .offset= 0}}},
                                 .rank= 2,
                                 .dimensions=dimensions_onnx__MatMul_280,
                                 .memType= QNN_TENSORMEMTYPE_RAW,
                                 {.clientBuf= { .data=BINVARSTART(onnx__MatMul_280),
                                                .dataSize=BINLEN(onnx__MatMul_280)}},
                                 .isDynamicDimensions= nullptr,
                                 .sparseParams= { QNN_SPARSE_LAYOUT_UNDEFINED,
                                                  .hybridCoo= {.numSpecifiedElements= 0, .numSparseDimensions= 0}},
                                 .isProduced= 0}}}
...
static ModelError_t addTensor_onnx__MatMul_281(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;
  uint32_t dimensions_onnx__MatMul_281[] = {4864, 896};
  VALIDATE(model.addTensor("onnx__MatMul_281", // Tensor Name
                           (Qnn_Tensor_t) {
                               .version= QNN_TENSOR_VERSION_2,
                               {.v2= {
                                 .id=0,
                                 .name= "onnx__MatMul_281",
                                 .type= QNN_TENSOR_TYPE_STATIC,
                                 .dataFormat= QNN_TENSOR_DATA_FORMAT_DENSE,
                                 .dataType= QNN_DATATYPE_FLOAT_32,
                                 .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                                                    ...
                                                    {.scaleOffsetEncoding= {.scale= 0.0000000000000000000000000000000000000000f, .offset= 0}}},
                                 .rank= 2,
                                 .dimensions=dimensions_onnx__MatMul_281,
                                 .memType= QNN_TENSORMEMTYPE_RAW,
                                 {.clientBuf= { .data=BINVARSTART(onnx__MatMul_281),
                                                .dataSize=BINLEN(onnx__MatMul_281)}},
                                 .isDynamicDimensions= nullptr,
                                 .sparseParams= { QNN_SPARSE_LAYOUT_UNDEFINED,
                                                  .hybridCoo= {.numSpecifiedElements= 0, .numSparseDimensions= 0}},
                                 .isProduced= 0}}}
...
static ModelError_t addTensor_onnx__MatMul_282(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;
  uint32_t dimensions_onnx__MatMul_282[] = {896, 4864};
  VALIDATE(model.addTensor("onnx__MatMul_282", // Tensor Name
                           (Qnn_Tensor_t) {
                               .version= QNN_TENSOR_VERSION_2,
                               {.v2= {
                                 .id=0,
                                 .name= "onnx__MatMul_282",
                                 .type= QNN_TENSOR_TYPE_STATIC,
                                 .dataFormat= QNN_TENSOR_DATA_FORMAT_DENSE,
                                 .dataType= QNN_DATATYPE_FLOAT_32,
                                 .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                                                    ...
                                                    {.scaleOffsetEncoding= {.scale= 0.0000000000000000000000000000000000000000f, .offset= 0}}},
                                 .rank= 2,
                                 .dimensions=dimensions_onnx__MatMul_282,
                                 .memType= QNN_TENSORMEMTYPE_RAW,
                                 {.clientBuf= { .data=BINVARSTART(onnx__MatMul_282),
                                                .dataSize=BINLEN(onnx__MatMul_282)}},
                                 .isDynamicDimensions= nullptr,
                                 .sparseParams= { QNN_SPARSE_LAYOUT_UNDEFINED,
                                                  .hybridCoo= {.numSpecifiedElements= 0, .numSparseDimensions= 0}},
                                 .isProduced= 0}}}
...
ModelError_t QnnModel_composeGraphs(Qnn_BackendHandle_t backendHandle,
  ...
  /* model/graph for qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv*/
  QnnModel qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv;
  const QnnGraph_Config_t** graphConfigs = nullptr;
  VALIDATE(getQnnGraphConfigFromInfo("qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv", graphsConfigInfo, numGraphsConfigInfo, graphConfigs), err);
  VALIDATE(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv.initialize(backendHandle, interface, contextHandle, "qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv", debug, DO_GRAPH_NODE_VALIDATIONS, graphConfigs), err);
  VALIDATE(addTensor_hidden_states(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addTensor_past_key(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addTensor_past_value(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addNode_hidden_states_ncf(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addNode_past_value_nchw(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addTensor_input_layernorm_weight(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addTensor_input_layernorm_weight_bias(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addNode_rms_norm__Mul_1_output_0(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addTensor_onnx__MatMul_227(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addTensor_self_attn_q_proj_bias(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addNode__MatMul(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addNode__MatMul_post_reshape(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addTensor_onnx__MatMul_228(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addTensor_self_attn_k_proj_bias(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addNode__MatMul_1(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addNode__MatMul_1_post_reshape(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addTensor_onnx__MatMul_229(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addTensor_self_attn_v_proj_bias(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addNode__MatMul_2(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addNode__MatMul_2_post_reshape(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addNode__Transpose(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addNode__Transpose_1(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addNode__Transpose_2(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addNode__Slice(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addNode__Slice_1(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addTensor_onnx__Mul_253(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addNode__Mul_2(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addTensor_onnx__Mul_254(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addNode__Mul_3(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addNode__Sub(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addNode__Mul_4(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addNode__Mul_5(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addNode__Add_4(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addNode__Unsqueeze(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addNode__Unsqueeze_1(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addNode__Concat(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addNode__Reshape_3(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addNode__Slice_3(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addNode__Slice_4(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addNode__Mul_6(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addNode__Mul_7(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addNode__Sub_1(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addNode__Mul_8(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addNode__Mul_9(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addNode__Add_5(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addNode__Unsqueeze_2(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addNode__Unsqueeze_3(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addNode__Concat_2(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addNode__Reshape_4(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addNode_current_key_nhwc(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addNode__Concat_4(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addNode__Concat_4_output_0_nchw(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addNode__Concat_5(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addNode__Unsqueeze_4(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addNode__MatMul_3(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addTensor__Constant_36_output_0(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addNode__Div_1(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addTensor_onnx__Add_269(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addNode__Add_6(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addNode__Softmax(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addNode__Unsqueeze_5(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addNode__MatMul_4(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addNode__Reshape_6(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addNode__Transpose_4(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addTensor_onnx__MatMul_279(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addNode__MatMul_5(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addNode__MatMul_5_post_reshape(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addNode__MatMul_5_output_0_nfc(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addNode__Add_7(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addNode__Add_7_output_0_ncf(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addTensor_post_attention_layernorm_weight(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addTensor_post_attention_layernorm_weight_bias(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addNode_rms_norm__Mul_11_output_0(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addTensor_onnx__MatMul_280(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addNode__MatMul_6(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addNode__MatMul_6_post_reshape(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addTensor_onnx__MatMul_281(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addNode__MatMul_7(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addNode__MatMul_7_post_reshape(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addNode__Sigmoid(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addNode__Mul_12(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addNode__Mul_13(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addTensor_onnx__MatMul_282(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addNode__MatMul_8(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addNode__MatMul_8_post_reshape(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addNode__MatMul_8_output_0_nfc(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);
  VALIDATE(addNode__Add_9(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv), err);

  // Add all models to array to get graphsInfo
  QnnModel* models [] = {&qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv};
