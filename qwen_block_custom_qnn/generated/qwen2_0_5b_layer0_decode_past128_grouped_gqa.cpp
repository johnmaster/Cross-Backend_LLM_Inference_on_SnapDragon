...
static ModelError_t addNode__Concat_4(QnnModel& model){
  ...
  uint32_t dimensions_present_key[] = {1, 129, 64, 2};
...
static ModelError_t addNode_present_key_nchw(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;

  /* ADDING NODE FOR present_key_nchw */
  uint32_t dimensions_present_key_nchw_perm[] = {4};
  uint32_t present_key_nchw_perm[] = {0, 3, 2, 1};
  Qnn_Param_t params_present_key_nchw[] = {
    {.paramType=QNN_PARAMTYPE_TENSOR,
     .name="perm",
     {.tensorParam=(Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            ...
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000000000000000000000000000f, .offset= 0}}},
            .rank= 1,
            .dimensions=dimensions_present_key_nchw_perm,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=(uint8_t*)present_key_nchw_perm,
                           .dataSize=16}},
            .isDynamicDimensions= nullptr,
            .sparseParams= { QNN_SPARSE_LAYOUT_UNDEFINED,
                             .hybridCoo= {.numSpecifiedElements= 0, .numSparseDimensions= 0}},
  ...
  const char*  inputs_present_key_nchw[] = {
    "present_key"
  };
  uint32_t dimensions__Transpose_3_output_0[] = {1, 2, 64, 129};
  Qnn_Tensor_t outputs_present_key_nchw[] = {
    (Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
  ...
  VALIDATE(model.addNode(QNN_OPCONFIG_VERSION_1, // Op_Config_t Version
                         "present_key_nchw", // Node Name
                         "qti.aisw", // Package Name
                         "Transpose", // Qnn Node Type
                         params_present_key_nchw, // Node Params
                         1, // Num Node Params
                         inputs_present_key_nchw, // Input Tensor Names
                         1, // Num Input Tensor Names
                         outputs_present_key_nchw, // Output Tensors 
                         1// Num Output Tensors 
  ), err);
  return err;
}
...
static ModelError_t addNode__Concat_5(QnnModel& model){
  ...
  uint32_t dimensions_present_value[] = {1, 2, 129, 64};
...
ModelError_t QnnModel_composeGraphs(Qnn_BackendHandle_t backendHandle,
  ...
  /* model/graph for qwen2_0_5b_layer0_decode_past128_grouped_gqa*/
  QnnModel qwen2_0_5b_layer0_decode_past128_grouped_gqa;
  const QnnGraph_Config_t** graphConfigs = nullptr;
  VALIDATE(getQnnGraphConfigFromInfo("qwen2_0_5b_layer0_decode_past128_grouped_gqa", graphsConfigInfo, numGraphsConfigInfo, graphConfigs), err);
  VALIDATE(qwen2_0_5b_layer0_decode_past128_grouped_gqa.initialize(backendHandle, interface, contextHandle, "qwen2_0_5b_layer0_decode_past128_grouped_gqa", debug, DO_GRAPH_NODE_VALIDATIONS, graphConfigs), err);
  VALIDATE(addTensor_hidden_states(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addTensor_past_key(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addTensor_past_value(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addNode_hidden_states_ncf(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addNode_past_value_nchw(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addTensor_input_layernorm_weight(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addTensor_input_layernorm_weight_bias(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addNode_rms_norm__Mul_1_output_0(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addTensor_onnx__MatMul_227(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addTensor_self_attn_q_proj_bias(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addNode__MatMul(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addNode__MatMul_post_reshape(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addTensor_onnx__MatMul_228(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addTensor_self_attn_k_proj_bias(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addNode__MatMul_1(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addNode__MatMul_1_post_reshape(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addTensor_onnx__MatMul_229(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addTensor_self_attn_v_proj_bias(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addNode__MatMul_2(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addNode__MatMul_2_post_reshape(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addNode__Transpose(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addNode__Transpose_1(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addNode__Transpose_2(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addNode__Slice(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addNode__Slice_1(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addTensor_onnx__Mul_253(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addNode__Mul_2(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addTensor_onnx__Mul_254(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addNode__Mul_3(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addNode__Sub(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addNode__Mul_4(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addNode__Mul_5(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addNode__Add_4(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addNode__Unsqueeze(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addNode__Unsqueeze_1(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addNode__Concat(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addNode__Reshape_3(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addNode__Slice_3(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addNode__Slice_4(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addNode__Mul_6(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addNode__Mul_7(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addNode__Sub_1(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addNode__Mul_8(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addNode__Mul_9(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addNode__Add_5(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addNode__Unsqueeze_2(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addNode__Unsqueeze_3(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addNode__Concat_2(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addNode__Reshape_4(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addNode__Reshape_4_output_0_nhwc(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addNode__Concat_4(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addNode_present_key_nchw(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addNode__Concat_5(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addNode__Unsqueeze_4(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addNode__MatMul_3(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addTensor__Constant_36_output_0(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addNode__Div_1(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addTensor_onnx__Add_269(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addNode__Add_6(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addNode__Softmax(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addNode__Unsqueeze_5(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addNode__MatMul_4(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addNode__Reshape_6(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addNode__Transpose_4(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addTensor_onnx__MatMul_279(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addNode__MatMul_5(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addNode__MatMul_5_post_reshape(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addNode__MatMul_5_output_0_nfc(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addNode__Add_7(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addNode__Add_7_output_0_ncf(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addTensor_post_attention_layernorm_weight(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addTensor_post_attention_layernorm_weight_bias(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addNode_rms_norm__Mul_11_output_0(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addTensor_onnx__MatMul_280(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addNode__MatMul_6(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addNode__MatMul_6_post_reshape(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addTensor_onnx__MatMul_281(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addNode__MatMul_7(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addNode__MatMul_7_post_reshape(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addNode__Sigmoid(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addNode__Mul_12(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addNode__Mul_13(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addTensor_onnx__MatMul_282(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addNode__MatMul_8(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addNode__MatMul_8_post_reshape(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addNode__MatMul_8_output_0_nfc(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);
  VALIDATE(addNode__Add_9(qwen2_0_5b_layer0_decode_past128_grouped_gqa), err);

  // Add all models to array to get graphsInfo
  QnnModel* models [] = {&qwen2_0_5b_layer0_decode_past128_grouped_gqa};
