/* Retargeted by qwen_block_custom_qnn/tools/patch_qwen_prefill_q_proj_static_rhs_precomputed.py.
 * The package is unchanged; only q_proj selects the graph-load static-RHS kernel.
 */
...
static ModelError_t addNode__MatMul(QnnModel& model){
  ...
  VALIDATE(model.addNode(QNN_OPCONFIG_VERSION_1,
                         ...
                         "MatMulQhpiHvxStaticRhsPrecomputed",
                         nullptr,
                         0,
