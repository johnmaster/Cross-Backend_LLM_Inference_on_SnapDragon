...
static ModelError_t addTensor_hidden_states(QnnModel& model){
  ...
  uint32_t dimensions_hidden_states[] = {1, 896, 1};
...
static ModelError_t addTensor_past_key(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;
  uint32_t dimensions_past_key[] = {1, 128, 64, 2};
  VALIDATE(model.addTensor("past_key", // Tensor Name
                           (Qnn_Tensor_t) {
                               .version= QNN_TENSOR_VERSION_2,
                               {.v2= {
                                 .id=0,
                                 ...
                                 .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                                                    ...
                                                    {.scaleOffsetEncoding= {.scale= 0.0000000000000000000000000000000000000000f, .offset= 0}}},
                                 .rank= 4,
                                 .dimensions=dimensions_past_key,
                                 .memType= QNN_TENSORMEMTYPE_RAW,
                                 {.clientBuf= { .data=nullptr,
                                                .dataSize=0}},
                                 .isDynamicDimensions= nullptr,
...
static ModelError_t addTensor_past_value(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;
  uint32_t dimensions_past_value[] = {1, 128, 64, 2};
  VALIDATE(model.addTensor("past_value", // Tensor Name
                           (Qnn_Tensor_t) {
                               .version= QNN_TENSOR_VERSION_2,
                               {.v2= {
                                 .id=0,
                                 ...
                                 .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                                                    ...
                                                    {.scaleOffsetEncoding= {.scale= 0.0000000000000000000000000000000000000000f, .offset= 0}}},
                                 .rank= 4,
                                 .dimensions=dimensions_past_value,
                                 .memType= QNN_TENSORMEMTYPE_RAW,
                                 {.clientBuf= { .data=nullptr,
                                                .dataSize=0}},
                                 .isDynamicDimensions= nullptr,
...
static ModelError_t addNode_past_key_fp32(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;
  const char* inputs[] = {"past_key"};
...
static ModelError_t addNode_past_value_fp32(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;
  const char* inputs[] = {"past_value"};
  uint32_t dimensions[] = {1, 128, 64, 2};
  Qnn_Tensor_t outputs[] = {
    (Qnn_Tensor_t) {
      .version=QNN_TENSOR_VERSION_2,
...
static ModelError_t addNode_hidden_states_ncf(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;

  /* ADDING NODE FOR hidden_states_ncf */
  uint32_t dimensions_hidden_states_ncf_perm[] = {3};
  uint32_t hidden_states_ncf_perm[] = {0, 2, 1};
  Qnn_Param_t params_hidden_states_ncf[] = {
     ...
     {.tensorParam=(Qnn_Tensor_t) {
          ...
          {.v2= {
            ...
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000000000000000000000000000f, .offset= 0}}},
            .rank= 1,
            .dimensions=dimensions_hidden_states_ncf_perm,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=(uint8_t*)hidden_states_ncf_perm,
                           .dataSize=12}},
            .isDynamicDimensions= nullptr,
            .sparseParams= { QNN_SPARSE_LAYOUT_UNDEFINED,
                             .hybridCoo= {.numSpecifiedElements= 0, .numSparseDimensions= 0}},
  ...
  const char*  inputs_hidden_states_ncf[] = {
    "hidden_states"
  };
  uint32_t dimensions_hidden_states_ncf[] = {1, 1, 896};
  Qnn_Tensor_t outputs_hidden_states_ncf[] = {
    (Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
            .name= "hidden_states_ncf",
            .type= QNN_TENSOR_TYPE_NATIVE,
            .dataFormat= QNN_TENSOR_DATA_FORMAT_DENSE,
            .dataType= QNN_DATATYPE_FLOAT_32,
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000000000000000000000000000f, .offset= 0}}},
            .rank= 3,
            .dimensions=dimensions_hidden_states_ncf,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=nullptr,
                           .dataSize=0}},
            .isDynamicDimensions= nullptr,
  ...
  VALIDATE(model.addNode(QNN_OPCONFIG_VERSION_1, // Op_Config_t Version
                         "hidden_states_ncf", // Node Name
                         "qti.aisw", // Package Name
                         "Transpose", // Qnn Node Type
                         params_hidden_states_ncf, // Node Params
                         1, // Num Node Params
                         inputs_hidden_states_ncf, // Input Tensor Names
                         1, // Num Input Tensor Names
                         outputs_hidden_states_ncf, // Output Tensors 
...
static ModelError_t addNode_rms_norm__Mul_1_output_0(QnnModel& model){
  ...
  uint32_t dimensions__Mul_1_output_0[] = {1, 1, 896};
...
static ModelError_t addTensor_onnx__MatMul_231(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;
  uint32_t dimensions_onnx__MatMul_231[] = {896, 896};
  VALIDATE(model.addTensor("onnx__MatMul_231", // Tensor Name
                           (Qnn_Tensor_t) {
                               .version= QNN_TENSOR_VERSION_2,
                               {.v2= {
                                 .id=0,
                                 .name= "onnx__MatMul_231",
                                 .type= QNN_TENSOR_TYPE_STATIC,
                                 .dataFormat= QNN_TENSOR_DATA_FORMAT_DENSE,
                                 .dataType= QNN_DATATYPE_FLOAT_32,
                                 .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                                                    ...
                                                    {.scaleOffsetEncoding= {.scale= 0.0000000000000000000000000000000000000000f, .offset= 0}}},
                                 .rank= 2,
                                 .dimensions=dimensions_onnx__MatMul_231,
                                 .memType= QNN_TENSORMEMTYPE_RAW,
                                 {.clientBuf= { .data=BINVARSTART(onnx__MatMul_231),
                                                .dataSize=BINLEN(onnx__MatMul_231)}},
                                 .isDynamicDimensions= nullptr,
                                 .sparseParams= { QNN_SPARSE_LAYOUT_UNDEFINED,
                                                  .hybridCoo= {.numSpecifiedElements= 0, .numSparseDimensions= 0}},
                                 .isProduced= 0}}}
...
static ModelError_t addNode__MatMul(QnnModel& model){
  ...
  uint32_t dimensions__Add_1_output_0_fc[] = {1, 896};
...
static ModelError_t addNode__MatMul_post_reshape(QnnModel& model){
  ...
  uint32_t dimensions__Reshape_output_0[] = {1, 1, 14, 64};
...
static ModelError_t addTensor_onnx__MatMul_232(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;
  uint32_t dimensions_onnx__MatMul_232[] = {128, 896};
  VALIDATE(model.addTensor("onnx__MatMul_232", // Tensor Name
                           (Qnn_Tensor_t) {
                               .version= QNN_TENSOR_VERSION_2,
                               {.v2= {
                                 .id=0,
                                 .name= "onnx__MatMul_232",
                                 .type= QNN_TENSOR_TYPE_STATIC,
                                 .dataFormat= QNN_TENSOR_DATA_FORMAT_DENSE,
                                 .dataType= QNN_DATATYPE_FLOAT_32,
                                 .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                                                    ...
                                                    {.scaleOffsetEncoding= {.scale= 0.0000000000000000000000000000000000000000f, .offset= 0}}},
                                 .rank= 2,
                                 .dimensions=dimensions_onnx__MatMul_232,
                                 .memType= QNN_TENSORMEMTYPE_RAW,
                                 {.clientBuf= { .data=BINVARSTART(onnx__MatMul_232),
                                                .dataSize=BINLEN(onnx__MatMul_232)}},
                                 .isDynamicDimensions= nullptr,
                                 .sparseParams= { QNN_SPARSE_LAYOUT_UNDEFINED,
                                                  .hybridCoo= {.numSpecifiedElements= 0, .numSparseDimensions= 0}},
                                 .isProduced= 0}}}
...
static ModelError_t addNode__MatMul_1(QnnModel& model){
  ...
  uint32_t dimensions__Add_2_output_0_fc[] = {1, 128};
...
static ModelError_t addNode__MatMul_1_post_reshape(QnnModel& model){
  ...
  uint32_t dimensions__Reshape_1_output_0[] = {1, 1, 2, 64};
...
static ModelError_t addTensor_onnx__MatMul_233(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;
  uint32_t dimensions_onnx__MatMul_233[] = {128, 896};
  VALIDATE(model.addTensor("onnx__MatMul_233", // Tensor Name
                           (Qnn_Tensor_t) {
                               .version= QNN_TENSOR_VERSION_2,
                               {.v2= {
                                 .id=0,
                                 .name= "onnx__MatMul_233",
                                 .type= QNN_TENSOR_TYPE_STATIC,
                                 .dataFormat= QNN_TENSOR_DATA_FORMAT_DENSE,
                                 .dataType= QNN_DATATYPE_FLOAT_32,
                                 .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                                                    ...
                                                    {.scaleOffsetEncoding= {.scale= 0.0000000000000000000000000000000000000000f, .offset= 0}}},
                                 .rank= 2,
                                 .dimensions=dimensions_onnx__MatMul_233,
                                 .memType= QNN_TENSORMEMTYPE_RAW,
                                 {.clientBuf= { .data=BINVARSTART(onnx__MatMul_233),
                                                .dataSize=BINLEN(onnx__MatMul_233)}},
                                 .isDynamicDimensions= nullptr,
                                 .sparseParams= { QNN_SPARSE_LAYOUT_UNDEFINED,
                                                  .hybridCoo= {.numSpecifiedElements= 0, .numSparseDimensions= 0}},
                                 .isProduced= 0}}}
...
static ModelError_t addNode__MatMul_2(QnnModel& model){
  ...
  uint32_t dimensions__Add_3_output_0_fc[] = {1, 128};
...
static ModelError_t addNode__MatMul_2_post_reshape(QnnModel& model){
  ...
  uint32_t dimensions__Reshape_2_output_0[] = {1, 1, 2, 64};
...
static ModelError_t addNode__Transpose(QnnModel& model){
  ...
  uint32_t dimensions__Transpose_output_0[] = {1, 14, 1, 64};
...
static ModelError_t addNode__Transpose_1(QnnModel& model){
  ...
  uint32_t dimensions__Transpose_1_output_0[] = {1, 2, 1, 64};
...
static ModelError_t addNode__Transpose_2(QnnModel& model){
  ...
  uint32_t dimensions__Transpose_2_output_0[] = {1, 2, 1, 64};
...
static ModelError_t addNode__Transpose_2_output_0_nhwc(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;

  /* ADDING NODE FOR _Transpose_2_output_0_nhwc */
  uint32_t dimensions__Transpose_2_output_0_nhwc_perm[] = {4};
  uint32_t _Transpose_2_output_0_nhwc_perm[] = {0, 1, 3, 2};
  Qnn_Param_t params__Transpose_2_output_0_nhwc[] = {
    {.paramType=QNN_PARAMTYPE_TENSOR,
     .name="perm",
     {.tensorParam=(Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
            .name= "_Transpose_2_output_0_nhwc_perm",
            .type= QNN_TENSOR_TYPE_STATIC,
            .dataFormat= QNN_TENSOR_DATA_FORMAT_DENSE,
            .dataType= QNN_DATATYPE_UINT_32,
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000000000000000000000000000f, .offset= 0}}},
            .rank= 1,
            .dimensions=dimensions__Transpose_2_output_0_nhwc_perm,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=(uint8_t*)_Transpose_2_output_0_nhwc_perm,
                           .dataSize=16}},
            .isDynamicDimensions= nullptr,
            .sparseParams= { QNN_SPARSE_LAYOUT_UNDEFINED,
                             .hybridCoo= {.numSpecifiedElements= 0, .numSparseDimensions= 0}},
  ...
  const char*  inputs__Transpose_2_output_0_nhwc[] = {
    "_Reshape_2_output_0"
  };
  uint32_t dimensions__Transpose_2_output_0_nhwc[] = {1, 1, 64, 2};
  Qnn_Tensor_t outputs__Transpose_2_output_0_nhwc[] = {
    (Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
            .name= "_Transpose_2_output_0_nhwc",
            .type= QNN_TENSOR_TYPE_NATIVE,
            .dataFormat= QNN_TENSOR_DATA_FORMAT_DENSE,
            .dataType= QNN_DATATYPE_FLOAT_32,
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000000000000000000000000000f, .offset= 0}}},
            .rank= 4,
            .dimensions=dimensions__Transpose_2_output_0_nhwc,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=nullptr,
                           .dataSize=0}},
            .isDynamicDimensions= nullptr,
  ...
  VALIDATE(model.addNode(QNN_OPCONFIG_VERSION_1, // Op_Config_t Version
                         "_Transpose_2_output_0_nhwc", // Node Name
                         "qti.aisw", // Package Name
                         "Transpose", // Qnn Node Type
                         params__Transpose_2_output_0_nhwc, // Node Params
                         1, // Num Node Params
                         inputs__Transpose_2_output_0_nhwc, // Input Tensor Names
                         1, // Num Input Tensor Names
                         outputs__Transpose_2_output_0_nhwc, // Output Tensors 
                         1// Num Output Tensors 
  ), err);
  return err;
}
...
static ModelError_t addNode__Slice(QnnModel& model){
  ...
  int32_t _Slice_ranges[] = {0, 1, 1, 0, 14, 1, 0, 1, 1, 0, 64, 2};
  ...
  uint32_t dimensions__Slice_output_0[] = {1, 14, 1, 32};
...
static ModelError_t addNode__Slice_1(QnnModel& model){
  ...
  int32_t _Slice_1_ranges[] = {0, 1, 1, 0, 14, 1, 0, 1, 1, 1, 64, 2};
  ...
  uint32_t dimensions__Slice_1_output_0[] = {1, 14, 1, 32};
...
static ModelError_t addTensor_onnx__Mul_257(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;
  uint32_t dimensions_onnx__Mul_257[] = {1, 1, 1, 32};
  VALIDATE(model.addTensor("onnx__Mul_257", // Tensor Name
                           (Qnn_Tensor_t) {
                               .version= QNN_TENSOR_VERSION_2,
                               {.v2= {
                                 .id=0,
                                 ...
                                 .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                                                    ...
                                                    {.scaleOffsetEncoding= {.scale= 0.0000000000000000000000000000000000000000f, .offset= 0}}},
                                 .rank= 4,
                                 .dimensions=dimensions_onnx__Mul_257,
                                 .memType= QNN_TENSORMEMTYPE_RAW,
                                 {.clientBuf= { .data=BINVARSTART(onnx__Mul_257),
                                                .dataSize=BINLEN(onnx__Mul_257)}},
                                 .isDynamicDimensions= nullptr,
                                 .sparseParams= { QNN_SPARSE_LAYOUT_UNDEFINED,
                                                  .hybridCoo= {.numSpecifiedElements= 0, .numSparseDimensions= 0}},
                                 .isProduced= 0}}}
...
static ModelError_t addNode__Mul_2(QnnModel& model){
  ...
  uint32_t dimensions__Mul_2_output_0[] = {1, 14, 1, 32};
...
static ModelError_t addTensor_onnx__Mul_258(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;
  uint32_t dimensions_onnx__Mul_258[] = {1, 1, 1, 32};
  VALIDATE(model.addTensor("onnx__Mul_258", // Tensor Name
                           (Qnn_Tensor_t) {
                               .version= QNN_TENSOR_VERSION_2,
                               {.v2= {
                                 .id=0,
                                 ...
                                 .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                                                    ...
                                                    {.scaleOffsetEncoding= {.scale= 0.0000000000000000000000000000000000000000f, .offset= 0}}},
                                 .rank= 4,
                                 .dimensions=dimensions_onnx__Mul_258,
                                 .memType= QNN_TENSORMEMTYPE_RAW,
                                 {.clientBuf= { .data=BINVARSTART(onnx__Mul_258),
                                                .dataSize=BINLEN(onnx__Mul_258)}},
                                 .isDynamicDimensions= nullptr,
                                 .sparseParams= { QNN_SPARSE_LAYOUT_UNDEFINED,
                                                  .hybridCoo= {.numSpecifiedElements= 0, .numSparseDimensions= 0}},
                                 .isProduced= 0}}}
...
static ModelError_t addNode__Mul_3(QnnModel& model){
  ...
  uint32_t dimensions__Mul_3_output_0[] = {1, 14, 1, 32};
...
static ModelError_t addNode__Sub(QnnModel& model){
  ...
  uint32_t dimensions__Sub_output_0[] = {1, 14, 1, 32};
...
static ModelError_t addNode__Mul_4(QnnModel& model){
  ...
  uint32_t dimensions__Mul_4_output_0[] = {1, 14, 1, 32};
...
static ModelError_t addNode__Mul_5(QnnModel& model){
  ...
  uint32_t dimensions__Mul_5_output_0[] = {1, 14, 1, 32};
...
static ModelError_t addNode__Add_4(QnnModel& model){
  ...
  uint32_t dimensions__Add_4_output_0[] = {1, 14, 1, 32};
...
static ModelError_t addNode__Unsqueeze(QnnModel& model){
  ...
  uint32_t dimensions__Unsqueeze_output_0[] = {1, 14, 1, 32, 1};
...
static ModelError_t addNode__Unsqueeze_1(QnnModel& model){
  ...
  uint32_t dimensions__Unsqueeze_1_output_0[] = {1, 14, 1, 32, 1};
...
static ModelError_t addNode__Concat(QnnModel& model){
  ...
  uint32_t dimensions__Concat_output_0[] = {1, 14, 1, 32, 2};
...
static ModelError_t addNode__Slice_3(QnnModel& model){
  ...
  int32_t _Slice_3_ranges[] = {0, 1, 1, 0, 2, 1, 0, 1, 1, 0, 64, 2};
  ...
  uint32_t dimensions__Slice_3_output_0[] = {1, 2, 1, 32};
...
static ModelError_t addNode__Slice_4(QnnModel& model){
  ...
  int32_t _Slice_4_ranges[] = {0, 1, 1, 0, 2, 1, 0, 1, 1, 1, 64, 2};
  ...
  uint32_t dimensions__Slice_4_output_0[] = {1, 2, 1, 32};
...
static ModelError_t addNode__Mul_6(QnnModel& model){
  ...
  uint32_t dimensions__Mul_6_output_0[] = {1, 2, 1, 32};
...
static ModelError_t addNode__Mul_7(QnnModel& model){
  ...
  uint32_t dimensions__Mul_7_output_0[] = {1, 2, 1, 32};
...
static ModelError_t addNode__Sub_1(QnnModel& model){
  ...
  uint32_t dimensions__Sub_1_output_0[] = {1, 2, 1, 32};
...
static ModelError_t addNode__Mul_8(QnnModel& model){
  ...
  uint32_t dimensions__Mul_8_output_0[] = {1, 2, 1, 32};
...
static ModelError_t addNode__Mul_9(QnnModel& model){
  ...
  uint32_t dimensions__Mul_9_output_0[] = {1, 2, 1, 32};
...
static ModelError_t addNode__Add_5(QnnModel& model){
  ...
  uint32_t dimensions__Add_5_output_0[] = {1, 2, 1, 32};
...
static ModelError_t addNode__Unsqueeze_2(QnnModel& model){
  ...
  uint32_t dimensions__Unsqueeze_2_output_0[] = {1, 2, 1, 32, 1};
...
static ModelError_t addNode__Unsqueeze_3(QnnModel& model){
  ...
  uint32_t dimensions__Unsqueeze_3_output_0[] = {1, 2, 1, 32, 1};
...
static ModelError_t addNode__Concat_2(QnnModel& model){
  ...
  uint32_t dimensions__Concat_2_output_0[] = {1, 2, 1, 32, 2};
...
static ModelError_t addNode__Reshape_4(QnnModel& model){
  ...
  uint32_t dimensions__Reshape_4_output_0[] = {1, 2, 1, 64};
...
static ModelError_t addNode__Reshape_4_output_0_nhwc(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;

  /* ADDING NODE FOR _Reshape_4_output_0_nhwc */
  uint32_t dimensions__Reshape_4_output_0_nhwc_perm[] = {4};
  uint32_t _Reshape_4_output_0_nhwc_perm[] = {0, 2, 3, 1};
  Qnn_Param_t params__Reshape_4_output_0_nhwc[] = {
    {.paramType=QNN_PARAMTYPE_TENSOR,
     .name="perm",
     {.tensorParam=(Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
            .name= "_Reshape_4_output_0_nhwc_perm",
            .type= QNN_TENSOR_TYPE_STATIC,
            .dataFormat= QNN_TENSOR_DATA_FORMAT_DENSE,
            .dataType= QNN_DATATYPE_UINT_32,
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000000000000000000000000000f, .offset= 0}}},
            .rank= 1,
            .dimensions=dimensions__Reshape_4_output_0_nhwc_perm,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=(uint8_t*)_Reshape_4_output_0_nhwc_perm,
                           .dataSize=16}},
            .isDynamicDimensions= nullptr,
            .sparseParams= { QNN_SPARSE_LAYOUT_UNDEFINED,
                             .hybridCoo= {.numSpecifiedElements= 0, .numSparseDimensions= 0}},
  ...
  const char*  inputs__Reshape_4_output_0_nhwc[] = {
    "_Reshape_4_output_0"
  };
  uint32_t dimensions__Reshape_4_output_0_nhwc[] = {1, 1, 64, 2};
  Qnn_Tensor_t outputs__Reshape_4_output_0_nhwc[] = {
    (Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
            .name= "_Reshape_4_output_0_nhwc",
            .type= QNN_TENSOR_TYPE_NATIVE,
            .dataFormat= QNN_TENSOR_DATA_FORMAT_DENSE,
            .dataType= QNN_DATATYPE_FLOAT_32,
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000000000000000000000000000f, .offset= 0}}},
            .rank= 4,
            .dimensions=dimensions__Reshape_4_output_0_nhwc,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=nullptr,
                           .dataSize=0}},
            .isDynamicDimensions= nullptr,
  ...
  VALIDATE(model.addNode(QNN_OPCONFIG_VERSION_1, // Op_Config_t Version
                         "_Reshape_4_output_0_nhwc", // Node Name
                         "qti.aisw", // Package Name
                         "Transpose", // Qnn Node Type
                         params__Reshape_4_output_0_nhwc, // Node Params
                         1, // Num Node Params
                         inputs__Reshape_4_output_0_nhwc, // Input Tensor Names
                         1, // Num Input Tensor Names
                         outputs__Reshape_4_output_0_nhwc, // Output Tensors 
                         1// Num Output Tensors 
  ), err);
  return err;
}

static ModelError_t addNode__Cast_1_output_0_nchw(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;

  /* ADDING NODE FOR _Cast_1_output_0_nchw */
  uint32_t dimensions__Cast_1_output_0_nchw_perm[] = {4};
  uint32_t _Cast_1_output_0_nchw_perm[] = {0, 3, 1, 2};
  Qnn_Param_t params__Cast_1_output_0_nchw[] = {
    {.paramType=QNN_PARAMTYPE_TENSOR,
     .name="perm",
     {.tensorParam=(Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
            .name= "_Cast_1_output_0_nchw_perm",
            .type= QNN_TENSOR_TYPE_STATIC,
            .dataFormat= QNN_TENSOR_DATA_FORMAT_DENSE,
            .dataType= QNN_DATATYPE_UINT_32,
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000000000000000000000000000f, .offset= 0}}},
            .rank= 1,
            .dimensions=dimensions__Cast_1_output_0_nchw_perm,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=(uint8_t*)_Cast_1_output_0_nchw_perm,
                           .dataSize=16}},
            .isDynamicDimensions= nullptr,
            .sparseParams= { QNN_SPARSE_LAYOUT_UNDEFINED,
                             .hybridCoo= {.numSpecifiedElements= 0, .numSparseDimensions= 0}},
  ...
  uint32_t dimensions__Cast_1_output_0_nchw[] = {1, 2, 128, 64};
  Qnn_Tensor_t outputs__Cast_1_output_0_nchw[] = {
    (Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
            .name= "_Cast_1_output_0_nchw",
            .type= QNN_TENSOR_TYPE_NATIVE,
            .dataFormat= QNN_TENSOR_DATA_FORMAT_DENSE,
            .dataType= QNN_DATATYPE_FLOAT_32,
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000000000000000000000000000f, .offset= 0}}},
            .rank= 4,
            .dimensions=dimensions__Cast_1_output_0_nchw,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=nullptr,
                           .dataSize=0}},
            .isDynamicDimensions= nullptr,
  ...
  VALIDATE(model.addNode(QNN_OPCONFIG_VERSION_1, // Op_Config_t Version
                         "_Cast_1_output_0_nchw", // Node Name
                         "qti.aisw", // Package Name
                         "Transpose", // Qnn Node Type
                         params__Cast_1_output_0_nchw, // Node Params
                         1, // Num Node Params
                         inputs__Cast_1_output_0_nchw, // Input Tensor Names
                         1, // Num Input Tensor Names
                         outputs__Cast_1_output_0_nchw, // Output Tensors 
                         1// Num Output Tensors 
  ), err);
  return err;
}

static ModelError_t addNode__Concat_4(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;

  /* ADDING NODE FOR _Concat_4 */
  Qnn_Param_t params__Concat_4[] = {
    {.paramType=QNN_PARAMTYPE_SCALAR,
     .name="axis",
  ...
  Qnn_Tensor_t outputs__Concat_4[] = {
    (Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
            .name= "_Concat_4_output_0",
            .type= QNN_TENSOR_TYPE_NATIVE,
            .dataFormat= QNN_TENSOR_DATA_FORMAT_DENSE,
            .dataType= QNN_DATATYPE_FLOAT_32,
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000000000000000000000000000f, .offset= 0}}},
            .rank= 4,
            .dimensions=dimensions__Concat_4_output_0,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=nullptr,
                           .dataSize=0}},
            .isDynamicDimensions= nullptr,
  ...
  VALIDATE(model.addNode(QNN_OPCONFIG_VERSION_1, // Op_Config_t Version
                         ...
                         "qti.aisw", // Package Name
                         "Concat", // Qnn Node Type
                         params__Concat_4, // Node Params
                         1, // Num Node Params
                         inputs__Concat_4, // Input Tensor Names
                         2, // Num Input Tensor Names
                         outputs__Concat_4, // Output Tensors 
                         1// Num Output Tensors 
  ), err);
  return err;
}

static ModelError_t addNode__Concat_4_output_0_nchw(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;

  /* ADDING NODE FOR _Concat_4_output_0_nchw */
  uint32_t dimensions__Concat_4_output_0_nchw_perm[] = {4};
  uint32_t _Concat_4_output_0_nchw_perm[] = {0, 3, 2, 1};
  Qnn_Param_t params__Concat_4_output_0_nchw[] = {
    {.paramType=QNN_PARAMTYPE_TENSOR,
     .name="perm",
     {.tensorParam=(Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
            .name= "_Concat_4_output_0_nchw_perm",
            .type= QNN_TENSOR_TYPE_STATIC,
            .dataFormat= QNN_TENSOR_DATA_FORMAT_DENSE,
            .dataType= QNN_DATATYPE_UINT_32,
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000000000000000000000000000f, .offset= 0}}},
            .rank= 1,
            .dimensions=dimensions__Concat_4_output_0_nchw_perm,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=(uint8_t*)_Concat_4_output_0_nchw_perm,
                           .dataSize=16}},
            .isDynamicDimensions= nullptr,
            .sparseParams= { QNN_SPARSE_LAYOUT_UNDEFINED,
                             .hybridCoo= {.numSpecifiedElements= 0, .numSparseDimensions= 0}},
  ...
  const char*  inputs__Concat_4_output_0_nchw[] = {
    "_Concat_4_output_0"
  };
  uint32_t dimensions__Transpose_3_output_0[] = {1, 2, 64, 129};
  Qnn_Tensor_t outputs__Concat_4_output_0_nchw[] = {
    (Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
  ...
  VALIDATE(model.addNode(QNN_OPCONFIG_VERSION_1, // Op_Config_t Version
                         "_Concat_4_output_0_nchw", // Node Name
                         "qti.aisw", // Package Name
                         "Transpose", // Qnn Node Type
                         params__Concat_4_output_0_nchw, // Node Params
                         1, // Num Node Params
                         inputs__Concat_4_output_0_nchw, // Input Tensor Names
                         1, // Num Input Tensor Names
                         outputs__Concat_4_output_0_nchw, // Output Tensors 
                         1// Num Output Tensors 
  ), err);
  return err;
}
...
static ModelError_t addNode__Concat_5(QnnModel& model){
  ...
  const char*  inputs__Concat_5[] = {
    "_Cast_1_output_0_nchw",
    "_Transpose_2_output_0"
  };
  uint32_t dimensions__Concat_5_output_0[] = {1, 2, 129, 64};
...
static ModelError_t addNode__Unsqueeze_4(QnnModel& model){
  ...
  uint32_t dimensions__Unsqueeze_4_output_0[] = {1, 2, 1, 64, 129};
...
static ModelError_t addNode__MatMul_3(QnnModel& model){
  ...
  uint32_t dimensions__MatMul_3_output_0[] = {1, 2, 7, 1, 129};
...
static ModelError_t addTensor__Constant_36_output_0(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;
  uint32_t dimensions__Constant_36_output_0[] = {1};
  VALIDATE(model.addTensor("_Constant_36_output_0", // Tensor Name
                           (Qnn_Tensor_t) {
                               .version= QNN_TENSOR_VERSION_2,
                               {.v2= {
                                 .id=0,
                                 .name= "_Constant_36_output_0",
                                 .type= QNN_TENSOR_TYPE_STATIC,
                                 .dataFormat= QNN_TENSOR_DATA_FORMAT_DENSE,
                                 .dataType= QNN_DATATYPE_FLOAT_32,
                                 .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                                                    ...
                                                    {.scaleOffsetEncoding= {.scale= 0.0000000000000000000000000000000000000000f, .offset= 0}}},
                                 .rank= 1,
                                 .dimensions=dimensions__Constant_36_output_0,
                                 .memType= QNN_TENSORMEMTYPE_RAW,
                                 {.clientBuf= { .data=BINVARSTART(_Constant_36_output_0),
                                                .dataSize=BINLEN(_Constant_36_output_0)}},
                                 .isDynamicDimensions= nullptr,
                                 .sparseParams= { QNN_SPARSE_LAYOUT_UNDEFINED,
                                                  .hybridCoo= {.numSpecifiedElements= 0, .numSparseDimensions= 0}},
                                 .isProduced= 0}}}
...
static ModelError_t addNode__Div_1(QnnModel& model){
  ...
  const char*  inputs__Div_1[] = {
    "_MatMul_3_output_0",
    "_Constant_36_output_0"
  };
  uint32_t dimensions__Div_1_output_0[] = {1, 2, 7, 1, 129};
...
static ModelError_t addTensor_onnx__Add_273(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;
  uint32_t dimensions_onnx__Add_273[] = {1, 1, 1, 1, 129};
  VALIDATE(model.addTensor("onnx__Add_273", // Tensor Name
                           (Qnn_Tensor_t) {
                               .version= QNN_TENSOR_VERSION_2,
                               {.v2= {
                                 .id=0,
                                 ...
                                 .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                                                    ...
                                                    {.scaleOffsetEncoding= {.scale= 0.0000000000000000000000000000000000000000f, .offset= 0}}},
                                 .rank= 5,
                                 .dimensions=dimensions_onnx__Add_273,
                                 .memType= QNN_TENSORMEMTYPE_RAW,
                                 {.clientBuf= { .data=BINVARSTART(onnx__Add_273),
                                                .dataSize=BINLEN(onnx__Add_273)}},
                                 .isDynamicDimensions= nullptr,
                                 .sparseParams= { QNN_SPARSE_LAYOUT_UNDEFINED,
                                                  .hybridCoo= {.numSpecifiedElements= 0, .numSparseDimensions= 0}},
                                 .isProduced= 0}}}
...
static ModelError_t addNode__Add_6(QnnModel& model){
  ...
  uint32_t dimensions__Add_6_output_0[] = {1, 2, 7, 1, 129};
...
static ModelError_t addNode__Softmax(QnnModel& model){
  ...
  uint32_t dimensions__Softmax_output_0[] = {1, 2, 7, 1, 129};
...
static ModelError_t addNode__Unsqueeze_5(QnnModel& model){
  ...
  uint32_t dimensions__Unsqueeze_5_output_0[] = {1, 2, 1, 129, 64};
...
static ModelError_t addNode__MatMul_4(QnnModel& model){
  ...
  uint32_t dimensions__MatMul_4_output_0[] = {1, 2, 7, 1, 64};
...
static ModelError_t addNode__Transpose_4(QnnModel& model){
  ...
  uint32_t dimensions__Transpose_4_output_0[] = {1, 1, 14, 64};
...
static ModelError_t addTensor_onnx__MatMul_283(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;
  uint32_t dimensions_onnx__MatMul_283[] = {896, 896};
  VALIDATE(model.addTensor("onnx__MatMul_283", // Tensor Name
                           (Qnn_Tensor_t) {
                               .version= QNN_TENSOR_VERSION_2,
                               {.v2= {
                                 .id=0,
                                 .name= "onnx__MatMul_283",
                                 .type= QNN_TENSOR_TYPE_STATIC,
                                 .dataFormat= QNN_TENSOR_DATA_FORMAT_DENSE,
                                 .dataType= QNN_DATATYPE_FLOAT_32,
                                 .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                                                    ...
                                                    {.scaleOffsetEncoding= {.scale= 0.0000000000000000000000000000000000000000f, .offset= 0}}},
                                 .rank= 2,
                                 .dimensions=dimensions_onnx__MatMul_283,
                                 .memType= QNN_TENSORMEMTYPE_RAW,
                                 {.clientBuf= { .data=BINVARSTART(onnx__MatMul_283),
                                                .dataSize=BINLEN(onnx__MatMul_283)}},
                                 .isDynamicDimensions= nullptr,
                                 .sparseParams= { QNN_SPARSE_LAYOUT_UNDEFINED,
                                                  .hybridCoo= {.numSpecifiedElements= 0, .numSparseDimensions= 0}},
                                 .isProduced= 0}}}
...
static ModelError_t addNode__MatMul_5(QnnModel& model){
  ...
  uint32_t dimensions__MatMul_5_output_0_fc[] = {1, 896};
...
static ModelError_t addNode__MatMul_5_post_reshape(QnnModel& model){
  ...
  uint32_t dimensions__MatMul_5_output_0[] = {1, 1, 896};
...
static ModelError_t addNode__MatMul_5_output_0_nfc(QnnModel& model){
  ...
  uint32_t dimensions__MatMul_5_output_0_nfc[] = {1, 896, 1};
...
static ModelError_t addNode__Add_7(QnnModel& model){
  ...
  uint32_t dimensions__Add_7_output_0[] = {1, 896, 1};
...
static ModelError_t addNode__Add_7_output_0_ncf(QnnModel& model){
  ...
  uint32_t dimensions__Add_7_output_0_ncf[] = {1, 1, 896};
...
static ModelError_t addNode_rms_norm__Mul_11_output_0(QnnModel& model){
  ...
  uint32_t dimensions__Mul_11_output_0[] = {1, 1, 896};
...
static ModelError_t addTensor_onnx__MatMul_284(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;
  uint32_t dimensions_onnx__MatMul_284[] = {4864, 896};
  VALIDATE(model.addTensor("onnx__MatMul_284", // Tensor Name
                           (Qnn_Tensor_t) {
                               .version= QNN_TENSOR_VERSION_2,
                               {.v2= {
                                 .id=0,
                                 .name= "onnx__MatMul_284",
                                 .type= QNN_TENSOR_TYPE_STATIC,
                                 .dataFormat= QNN_TENSOR_DATA_FORMAT_DENSE,
                                 .dataType= QNN_DATATYPE_FLOAT_32,
                                 .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                                                    ...
                                                    {.scaleOffsetEncoding= {.scale= 0.0000000000000000000000000000000000000000f, .offset= 0}}},
                                 .rank= 2,
                                 .dimensions=dimensions_onnx__MatMul_284,
                                 .memType= QNN_TENSORMEMTYPE_RAW,
                                 {.clientBuf= { .data=BINVARSTART(onnx__MatMul_284),
                                                .dataSize=BINLEN(onnx__MatMul_284)}},
                                 .isDynamicDimensions= nullptr,
                                 .sparseParams= { QNN_SPARSE_LAYOUT_UNDEFINED,
                                                  .hybridCoo= {.numSpecifiedElements= 0, .numSparseDimensions= 0}},
                                 .isProduced= 0}}}
...
static ModelError_t addNode__MatMul_6(QnnModel& model){
  ...
  uint32_t dimensions__MatMul_6_output_0_fc[] = {1, 4864};
...
static ModelError_t addNode__MatMul_6_post_reshape(QnnModel& model){
  ...
  uint32_t dimensions__MatMul_6_output_0[] = {1, 1, 4864};
...
static ModelError_t addTensor_onnx__MatMul_285(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;
  uint32_t dimensions_onnx__MatMul_285[] = {4864, 896};
  VALIDATE(model.addTensor("onnx__MatMul_285", // Tensor Name
                           (Qnn_Tensor_t) {
                               .version= QNN_TENSOR_VERSION_2,
                               {.v2= {
                                 .id=0,
                                 .name= "onnx__MatMul_285",
                                 .type= QNN_TENSOR_TYPE_STATIC,
                                 .dataFormat= QNN_TENSOR_DATA_FORMAT_DENSE,
                                 .dataType= QNN_DATATYPE_FLOAT_32,
                                 .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                                                    ...
                                                    {.scaleOffsetEncoding= {.scale= 0.0000000000000000000000000000000000000000f, .offset= 0}}},
                                 .rank= 2,
                                 .dimensions=dimensions_onnx__MatMul_285,
                                 .memType= QNN_TENSORMEMTYPE_RAW,
                                 {.clientBuf= { .data=BINVARSTART(onnx__MatMul_285),
                                                .dataSize=BINLEN(onnx__MatMul_285)}},
                                 .isDynamicDimensions= nullptr,
                                 .sparseParams= { QNN_SPARSE_LAYOUT_UNDEFINED,
                                                  .hybridCoo= {.numSpecifiedElements= 0, .numSparseDimensions= 0}},
                                 .isProduced= 0}}}
...
static ModelError_t addNode__MatMul_7(QnnModel& model){
  ...
  uint32_t dimensions__MatMul_7_output_0_fc[] = {1, 4864};
...
static ModelError_t addNode__MatMul_7_post_reshape(QnnModel& model){
  ...
  uint32_t dimensions__MatMul_7_output_0[] = {1, 1, 4864};
...
static ModelError_t addNode__Sigmoid(QnnModel& model){
  ...
  uint32_t dimensions__Sigmoid_output_0[] = {1, 1, 4864};
...
static ModelError_t addNode__Mul_12(QnnModel& model){
  ...
  uint32_t dimensions__Mul_12_output_0[] = {1, 1, 4864};
...
static ModelError_t addNode__Mul_13(QnnModel& model){
  ...
  uint32_t dimensions__Mul_13_output_0[] = {1, 1, 4864};
...
static ModelError_t addTensor_onnx__MatMul_286(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;
  uint32_t dimensions_onnx__MatMul_286[] = {896, 4864};
  VALIDATE(model.addTensor("onnx__MatMul_286", // Tensor Name
                           (Qnn_Tensor_t) {
                               .version= QNN_TENSOR_VERSION_2,
                               {.v2= {
                                 .id=0,
                                 .name= "onnx__MatMul_286",
                                 .type= QNN_TENSOR_TYPE_STATIC,
                                 .dataFormat= QNN_TENSOR_DATA_FORMAT_DENSE,
                                 .dataType= QNN_DATATYPE_FLOAT_32,
                                 .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                                                    ...
                                                    {.scaleOffsetEncoding= {.scale= 0.0000000000000000000000000000000000000000f, .offset= 0}}},
                                 .rank= 2,
                                 .dimensions=dimensions_onnx__MatMul_286,
                                 .memType= QNN_TENSORMEMTYPE_RAW,
                                 {.clientBuf= { .data=BINVARSTART(onnx__MatMul_286),
                                                .dataSize=BINLEN(onnx__MatMul_286)}},
                                 .isDynamicDimensions= nullptr,
                                 .sparseParams= { QNN_SPARSE_LAYOUT_UNDEFINED,
                                                  .hybridCoo= {.numSpecifiedElements= 0, .numSparseDimensions= 0}},
                                 .isProduced= 0}}}
...
static ModelError_t addNode__MatMul_8(QnnModel& model){
  ...
  uint32_t dimensions__MatMul_8_output_0_fc[] = {1, 896};
...
static ModelError_t addNode__MatMul_8_post_reshape(QnnModel& model){
  ...
  uint32_t dimensions__MatMul_8_output_0[] = {1, 1, 896};
...
static ModelError_t addNode__MatMul_8_output_0_nfc(QnnModel& model){
  ...
  uint32_t dimensions__MatMul_8_output_0_nfc[] = {1, 896, 1};
...
static ModelError_t addNode__Add_9(QnnModel& model){
  ...
  uint32_t dimensions_hidden_out[] = {1, 896, 1};
...
static ModelError_t addNode__Cast_2(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;

  /* ADDING NODE FOR _Cast_2 */
  const char*  inputs__Cast_2[] = {
    "_Reshape_4_output_0"
  };
  uint32_t dimensions_current_key[] = {1, 2, 1, 64};
  Qnn_Tensor_t outputs__Cast_2[] = {
    (Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
            ...
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000000000000000000000000000f, .offset= 0}}},
            .rank= 4,
            .dimensions=dimensions_current_key,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=nullptr,
                           .dataSize=0}},
            .isDynamicDimensions= nullptr,
  ...
  VALIDATE(model.addNode(QNN_OPCONFIG_VERSION_1, // Op_Config_t Version
                         ...
                         nullptr, // Node Params
                         0, // Num Node Params
                         inputs__Cast_2, // Input Tensor Names
                         1, // Num Input Tensor Names
                         outputs__Cast_2, // Output Tensors 
                         1// Num Output Tensors 
  ), err);
  return err;
}

static ModelError_t addNode__Cast_3(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;

  /* ADDING NODE FOR _Cast_3 */
  const char*  inputs__Cast_3[] = {
    "_Transpose_2_output_0_nhwc"
  };
  uint32_t dimensions_current_value[] = {1, 1, 64, 2};
  Qnn_Tensor_t outputs__Cast_3[] = {
    (Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
            ...
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000000000000000000000000000f, .offset= 0}}},
            .rank= 4,
            .dimensions=dimensions_current_value,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=nullptr,
                           .dataSize=0}},
            .isDynamicDimensions= nullptr,
  ...
  VALIDATE(model.addNode(QNN_OPCONFIG_VERSION_1, // Op_Config_t Version
                         ...
                         nullptr, // Node Params
                         0, // Num Node Params
                         inputs__Cast_3, // Input Tensor Names
                         1, // Num Input Tensor Names
                         outputs__Cast_3, // Output Tensors 
                         1// Num Output Tensors 
  ), err);
  return err;
}
...
ModelError_t QnnModel_composeGraphs(Qnn_BackendHandle_t backendHandle,
  ...
  /* model/graph for qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16*/
  QnnModel qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16;
  const QnnGraph_Config_t** graphConfigs = nullptr;
  VALIDATE(getQnnGraphConfigFromInfo("qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16", graphsConfigInfo, numGraphsConfigInfo, graphConfigs), err);
  VALIDATE(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16.initialize(backendHandle, interface, contextHandle, "qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16", debug, DO_GRAPH_NODE_VALIDATIONS, graphConfigs), err);
  VALIDATE(addTensor_hidden_states(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addTensor_past_key(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addTensor_past_value(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addNode_past_key_fp32(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addNode_past_value_fp32(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addNode_hidden_states_ncf(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addTensor_input_layernorm_weight(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addTensor_input_layernorm_weight_bias(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addNode_rms_norm__Mul_1_output_0(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addTensor_onnx__MatMul_231(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addTensor_self_attn_q_proj_bias(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addNode__MatMul(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addNode__MatMul_post_reshape(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addTensor_onnx__MatMul_232(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addTensor_self_attn_k_proj_bias(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addNode__MatMul_1(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addNode__MatMul_1_post_reshape(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addTensor_onnx__MatMul_233(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addTensor_self_attn_v_proj_bias(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addNode__MatMul_2(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addNode__MatMul_2_post_reshape(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addNode__Transpose(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addNode__Transpose_1(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addNode__Transpose_2(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addNode__Transpose_2_output_0_nhwc(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addNode__Slice(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addNode__Slice_1(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addTensor_onnx__Mul_257(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addNode__Mul_2(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addTensor_onnx__Mul_258(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addNode__Mul_3(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addNode__Sub(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addNode__Mul_4(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addNode__Mul_5(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addNode__Add_4(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addNode__Unsqueeze(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addNode__Unsqueeze_1(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addNode__Concat(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addNode__Reshape_3(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addNode__Slice_3(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addNode__Slice_4(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addNode__Mul_6(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addNode__Mul_7(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addNode__Sub_1(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addNode__Mul_8(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addNode__Mul_9(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addNode__Add_5(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addNode__Unsqueeze_2(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addNode__Unsqueeze_3(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addNode__Concat_2(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addNode__Reshape_4(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addNode__Reshape_4_output_0_nhwc(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addNode__Cast_1_output_0_nchw(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addNode__Concat_4(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addNode__Concat_4_output_0_nchw(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addNode__Concat_5(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addNode__Unsqueeze_4(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addNode__MatMul_3(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addTensor__Constant_36_output_0(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addNode__Div_1(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addTensor_onnx__Add_273(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addNode__Add_6(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addNode__Softmax(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addNode__Unsqueeze_5(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addNode__MatMul_4(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addNode__Reshape_6(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addNode__Transpose_4(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addTensor_onnx__MatMul_283(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addNode__MatMul_5(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addNode__MatMul_5_post_reshape(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addNode__MatMul_5_output_0_nfc(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addNode__Add_7(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addNode__Add_7_output_0_ncf(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addTensor_post_attention_layernorm_weight(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addTensor_post_attention_layernorm_weight_bias(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addNode_rms_norm__Mul_11_output_0(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addTensor_onnx__MatMul_284(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addNode__MatMul_6(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addNode__MatMul_6_post_reshape(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addTensor_onnx__MatMul_285(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addNode__MatMul_7(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addNode__MatMul_7_post_reshape(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addNode__Sigmoid(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addNode__Mul_12(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addNode__Mul_13(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addTensor_onnx__MatMul_286(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addNode__MatMul_8(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addNode__MatMul_8_post_reshape(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addNode__MatMul_8_output_0_nfc(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addNode__Add_9(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addNode__Cast_2(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);
  VALIDATE(addNode__Cast_3(qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16), err);

  // Add all models to array to get graphsInfo
  QnnModel* models [] = {&qwen2_0_5b_layer0_decode_past128_grouped_gqa_delta_kv_fp16};
