...
static ModelError_t addTensor_onnx__MatMul_230(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;
  uint32_t dimensions_onnx__MatMul_230[] = {896, 896};
  VALIDATE(model.addTensor("onnx__MatMul_230", // Tensor Name
                           (Qnn_Tensor_t) {
                               .version= QNN_TENSOR_VERSION_2,
                               {.v2= {
                                 .id=0,
                                 .name= "onnx__MatMul_230",
                                 .type= QNN_TENSOR_TYPE_STATIC,
                                 .dataFormat= QNN_TENSOR_DATA_FORMAT_DENSE,
                                 .dataType= QNN_DATATYPE_FLOAT_32,
                                 .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                                                    ...
                                                    {.scaleOffsetEncoding= {.scale= 0.0000000000000000000000000000000000000000f, .offset= 0}}},
                                 .rank= 2,
                                 .dimensions=dimensions_onnx__MatMul_230,
                                 .memType= QNN_TENSORMEMTYPE_RAW,
                                 {.clientBuf= { .data=BINVARSTART(onnx__MatMul_230),
                                                .dataSize=BINLEN(onnx__MatMul_230)}},
                                 .isDynamicDimensions= nullptr,
                                 .sparseParams= { QNN_SPARSE_LAYOUT_UNDEFINED,
                                                  .hybridCoo= {.numSpecifiedElements= 0, .numSparseDimensions= 0}},
                                 .isProduced= 0}}}
...
static ModelError_t addTensor_onnx__MatMul_231(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;
  uint32_t dimensions_onnx__MatMul_231[] = {128, 896};
...
static ModelError_t addTensor_onnx__Mul_256(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;
  uint32_t dimensions_onnx__Mul_256[] = {1, 1, 1, 32};
  VALIDATE(model.addTensor("onnx__Mul_256", // Tensor Name
                           (Qnn_Tensor_t) {
                               .version= QNN_TENSOR_VERSION_2,
                               {.v2= {
                                 .id=0,
                                 ...
                                 .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                                                    ...
                                                    {.scaleOffsetEncoding= {.scale= 0.0000000000000000000000000000000000000000f, .offset= 0}}},
                                 .rank= 4,
                                 .dimensions=dimensions_onnx__Mul_256,
                                 .memType= QNN_TENSORMEMTYPE_RAW,
                                 {.clientBuf= { .data=BINVARSTART(onnx__Mul_256),
                                                .dataSize=BINLEN(onnx__Mul_256)}},
                                 .isDynamicDimensions= nullptr,
                                 .sparseParams= { QNN_SPARSE_LAYOUT_UNDEFINED,
                                                  .hybridCoo= {.numSpecifiedElements= 0, .numSparseDimensions= 0}},
                                 .isProduced= 0}}}
...
static ModelError_t addNode__Reshape_3(QnnModel& model){
  ...
  uint32_t dimensions__Reshape_3_output_0[] = {1, 14, 1, 64};
...
static ModelError_t addNode_present_key_nchw(QnnModel& model){
  ...
  uint32_t present_key_nchw_perm[] = {0, 3, 1, 2};
  ...
  uint32_t dimensions_present_key_nchw[] = {1, 2, 129, 64};
  Qnn_Tensor_t outputs_present_key_nchw[] = {
    (Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
            .name= "present_key_nchw",
            .type= QNN_TENSOR_TYPE_NATIVE,
            .dataFormat= QNN_TENSOR_DATA_FORMAT_DENSE,
            .dataType= QNN_DATATYPE_FLOAT_32,
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000000000000000000000000000f, .offset= 0}}},
            .rank= 4,
            .dimensions=dimensions_present_key_nchw,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=nullptr,
                           .dataSize=0}},
            .isDynamicDimensions= nullptr,
...
static ModelError_t addNode__Unsqueeze_4(QnnModel& model){
  ...
  uint32_t dimensions__Unsqueeze_4_output_0[] = {1, 2, 1, 129, 64};
...
static ModelError_t addNode__Tile(QnnModel& model){
  ...
  uint32_t dimensions__Tile_output_0[] = {1, 2, 7, 129, 64};
...
static ModelError_t addNode__Reshape_5(QnnModel& model){
  ...
  uint32_t dimensions__Reshape_5_output_0[] = {1, 14, 129, 64};
...
static ModelError_t addNode__Tile_1(QnnModel& model){
  ...
  uint32_t dimensions__Tile_1_output_0[] = {1, 2, 7, 129, 64};
...
static ModelError_t addNode__Reshape_6(QnnModel& model){
  ...
  uint32_t dimensions__Reshape_6_output_0[] = {1, 14, 129, 64};
...
static ModelError_t addNode__Transpose_3(QnnModel& model){
  ...
  uint32_t dimensions__Transpose_3_output_0[] = {1, 14, 64, 129};
...
static ModelError_t addNode__MatMul_3(QnnModel& model){
  ...
  uint32_t dimensions__MatMul_3_output_0[] = {1, 14, 1, 129};
...
static ModelError_t addNode__Div_1(QnnModel& model){
  ...
  uint32_t dimensions__Div_1_output_0[] = {1, 14, 1, 129};
...
static ModelError_t addTensor_causal_mask(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;
  uint32_t dimensions_causal_mask[] = {1, 1, 1, 129};
...
static ModelError_t addNode__Add_6(QnnModel& model){
  ...
  uint32_t dimensions__Add_6_output_0[] = {1, 14, 1, 129};
...
static ModelError_t addNode__Softmax(QnnModel& model){
  ...
  uint32_t dimensions__Softmax_output_0[] = {1, 14, 1, 129};
...
static ModelError_t addNode__MatMul_4(QnnModel& model){
  ...
  uint32_t dimensions__MatMul_4_output_0[] = {1, 14, 1, 64};
...
static ModelError_t addTensor_onnx__MatMul_270(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;
  uint32_t dimensions_onnx__MatMul_270[] = {896, 896};
...
static ModelError_t addTensor_onnx__MatMul_271(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;
  uint32_t dimensions_onnx__MatMul_271[] = {4864, 896};
  VALIDATE(model.addTensor("onnx__MatMul_271", // Tensor Name
                           (Qnn_Tensor_t) {
                               .version= QNN_TENSOR_VERSION_2,
                               {.v2= {
                                 .id=0,
                                 .name= "onnx__MatMul_271",
                                 .type= QNN_TENSOR_TYPE_STATIC,
                                 .dataFormat= QNN_TENSOR_DATA_FORMAT_DENSE,
                                 .dataType= QNN_DATATYPE_FLOAT_32,
                                 .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                                                    ...
                                                    {.scaleOffsetEncoding= {.scale= 0.0000000000000000000000000000000000000000f, .offset= 0}}},
                                 .rank= 2,
                                 .dimensions=dimensions_onnx__MatMul_271,
                                 .memType= QNN_TENSORMEMTYPE_RAW,
                                 {.clientBuf= { .data=BINVARSTART(onnx__MatMul_271),
                                                .dataSize=BINLEN(onnx__MatMul_271)}},
                                 .isDynamicDimensions= nullptr,
                                 .sparseParams= { QNN_SPARSE_LAYOUT_UNDEFINED,
                                                  .hybridCoo= {.numSpecifiedElements= 0, .numSparseDimensions= 0}},
                                 .isProduced= 0}}}
...
static ModelError_t addTensor_onnx__MatMul_272(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;
  uint32_t dimensions_onnx__MatMul_272[] = {4864, 896};
  VALIDATE(model.addTensor("onnx__MatMul_272", // Tensor Name
                           (Qnn_Tensor_t) {
                               .version= QNN_TENSOR_VERSION_2,
                               {.v2= {
                                 .id=0,
                                 .name= "onnx__MatMul_272",
                                 .type= QNN_TENSOR_TYPE_STATIC,
                                 .dataFormat= QNN_TENSOR_DATA_FORMAT_DENSE,
                                 .dataType= QNN_DATATYPE_FLOAT_32,
                                 .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                                                    ...
                                                    {.scaleOffsetEncoding= {.scale= 0.0000000000000000000000000000000000000000f, .offset= 0}}},
                                 .rank= 2,
                                 .dimensions=dimensions_onnx__MatMul_272,
                                 .memType= QNN_TENSORMEMTYPE_RAW,
                                 {.clientBuf= { .data=BINVARSTART(onnx__MatMul_272),
                                                .dataSize=BINLEN(onnx__MatMul_272)}},
                                 .isDynamicDimensions= nullptr,
                                 .sparseParams= { QNN_SPARSE_LAYOUT_UNDEFINED,
                                                  .hybridCoo= {.numSpecifiedElements= 0, .numSparseDimensions= 0}},
                                 .isProduced= 0}}}
...
static ModelError_t addTensor_onnx__MatMul_273(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;
  uint32_t dimensions_onnx__MatMul_273[] = {896, 4864};
  VALIDATE(model.addTensor("onnx__MatMul_273", // Tensor Name
                           (Qnn_Tensor_t) {
                               .version= QNN_TENSOR_VERSION_2,
                               {.v2= {
                                 .id=0,
                                 .name= "onnx__MatMul_273",
                                 .type= QNN_TENSOR_TYPE_STATIC,
                                 .dataFormat= QNN_TENSOR_DATA_FORMAT_DENSE,
                                 .dataType= QNN_DATATYPE_FLOAT_32,
                                 .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                                                    ...
                                                    {.scaleOffsetEncoding= {.scale= 0.0000000000000000000000000000000000000000f, .offset= 0}}},
                                 .rank= 2,
                                 .dimensions=dimensions_onnx__MatMul_273,
                                 .memType= QNN_TENSORMEMTYPE_RAW,
                                 {.clientBuf= { .data=BINVARSTART(onnx__MatMul_273),
                                                .dataSize=BINLEN(onnx__MatMul_273)}},
                                 .isDynamicDimensions= nullptr,
                                 .sparseParams= { QNN_SPARSE_LAYOUT_UNDEFINED,
                                                  .hybridCoo= {.numSpecifiedElements= 0, .numSparseDimensions= 0}},
                                 .isProduced= 0}}}
...
ModelError_t QnnModel_composeGraphs(Qnn_BackendHandle_t backendHandle,
  ...
  /* model/graph for qwen2_0_5b_layer0_decode_past128*/
  QnnModel qwen2_0_5b_layer0_decode_past128;
  const QnnGraph_Config_t** graphConfigs = nullptr;
  VALIDATE(getQnnGraphConfigFromInfo("qwen2_0_5b_layer0_decode_past128", graphsConfigInfo, numGraphsConfigInfo, graphConfigs), err);
  VALIDATE(qwen2_0_5b_layer0_decode_past128.initialize(backendHandle, interface, contextHandle, "qwen2_0_5b_layer0_decode_past128", debug, DO_GRAPH_NODE_VALIDATIONS, graphConfigs), err);
  VALIDATE(addTensor_hidden_states(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addTensor_past_key(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addTensor_past_value(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addNode_hidden_states_ncf(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addNode_past_value_nchw(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addTensor_input_layernorm_weight(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addTensor_input_layernorm_weight_bias(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addNode_rms_norm__Mul_1_output_0(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addTensor_onnx__MatMul_230(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addTensor_self_attn_q_proj_bias(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addNode__MatMul(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addNode__MatMul_post_reshape(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addTensor_onnx__MatMul_231(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addTensor_self_attn_k_proj_bias(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addNode__MatMul_1(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addNode__MatMul_1_post_reshape(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addTensor_onnx__MatMul_232(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addTensor_self_attn_v_proj_bias(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addNode__MatMul_2(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addNode__MatMul_2_post_reshape(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addNode__Transpose(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addNode__Transpose_1(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addNode__Transpose_2(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addNode__Slice(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addNode__Slice_1(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addTensor_onnx__Mul_256(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addNode__Mul_2(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addTensor_onnx__Mul_257(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addNode__Mul_3(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addNode__Sub(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addNode__Mul_4(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addNode__Mul_5(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addNode__Add_4(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addNode__Unsqueeze(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addNode__Unsqueeze_1(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addNode__Concat(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addNode__Reshape_3(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addNode__Slice_3(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addNode__Slice_4(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addNode__Mul_6(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addNode__Mul_7(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addNode__Sub_1(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addNode__Mul_8(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addNode__Mul_9(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addNode__Add_5(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addNode__Unsqueeze_2(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addNode__Unsqueeze_3(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addNode__Concat_2(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addNode__Reshape_4(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addNode__Reshape_4_output_0_nhwc(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addNode__Concat_4(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addNode_present_key_nchw(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addNode__Concat_5(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addNode__Unsqueeze_4(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addNode__Tile(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addNode__Reshape_5(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addNode__Unsqueeze_5(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addNode__Tile_1(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addNode__Reshape_6(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addNode__Transpose_3(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addNode__MatMul_3(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addTensor__Constant_52_output_0(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addNode__Div_1(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addTensor_causal_mask(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addNode__Add_6(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addNode__Softmax(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addNode__MatMul_4(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addNode__Transpose_4(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addTensor_onnx__MatMul_270(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addNode__MatMul_5(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addNode__MatMul_5_post_reshape(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addNode__MatMul_5_output_0_nfc(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addNode__Add_7(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addNode__Add_7_output_0_ncf(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addTensor_post_attention_layernorm_weight(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addTensor_post_attention_layernorm_weight_bias(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addNode_rms_norm__Mul_11_output_0(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addTensor_onnx__MatMul_271(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addNode__MatMul_6(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addNode__MatMul_6_post_reshape(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addTensor_onnx__MatMul_272(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addNode__MatMul_7(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addNode__MatMul_7_post_reshape(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addNode__Sigmoid(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addNode__Mul_12(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addNode__Mul_13(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addTensor_onnx__MatMul_273(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addNode__MatMul_8(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addNode__MatMul_8_post_reshape(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addNode__MatMul_8_output_0_nfc(qwen2_0_5b_layer0_decode_past128), err);
  VALIDATE(addNode__Add_9(qwen2_0_5b_layer0_decode_past128), err);

  // Add all models to array to get graphsInfo
  QnnModel* models [] = {&qwen2_0_5b_layer0_decode_past128};
