...
ModelError_t QnnModel_composeGraphs(Qnn_BackendHandle_t backendHandle,
  ...
  /* model/graph for qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous*/
  QnnModel qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous;
  const QnnGraph_Config_t** graphConfigs = nullptr;
  VALIDATE(getQnnGraphConfigFromInfo("qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous", graphsConfigInfo, numGraphsConfigInfo, graphConfigs), err);
  VALIDATE(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous.initialize(backendHandle, interface, contextHandle, "qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous", debug, DO_GRAPH_NODE_VALIDATIONS, graphConfigs), err);
  VALIDATE(addTensor_hidden_states(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addTensor_past_key(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addTensor_past_value(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addNode_hidden_states_ncf(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addNode_past_value_nchw(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addTensor_input_layernorm_weight(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addTensor_input_layernorm_weight_bias(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addNode_rms_norm__Mul_1_output_0(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addTensor_onnx__MatMul_227(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addTensor_self_attn_q_proj_bias(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addNode__MatMul(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addNode__MatMul_post_reshape(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addTensor_onnx__MatMul_228(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addTensor_self_attn_k_proj_bias(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addNode__MatMul_1(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addNode__MatMul_1_post_reshape(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addTensor_onnx__MatMul_229(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addTensor_self_attn_v_proj_bias(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addNode__MatMul_2(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addNode__MatMul_2_post_reshape(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addNode__Transpose(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addNode__Transpose_1(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addNode__Transpose_2(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addNode__Slice(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addNode__Slice_1(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addTensor_onnx__Mul_253(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addNode__Mul_2(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addTensor_onnx__Mul_254(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addNode__Mul_3(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addNode__Sub(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addNode__Mul_4(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addNode__Mul_5(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addNode__Add_4(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addNode__Unsqueeze(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addNode__Unsqueeze_1(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addNode__Concat(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addNode__Reshape_3(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addNode__Slice_3(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addNode__Slice_4(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addNode__Mul_6(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addNode__Mul_7(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addNode__Sub_1(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addNode__Mul_8(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addNode__Mul_9(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addNode__Add_5(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addNode__Unsqueeze_2(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addNode__Unsqueeze_3(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addNode__Concat_2(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addNode__Reshape_4(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addNode__Concat_4(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addNode__Concat_5(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addNode__MatMul_4(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addNode__Transpose_4(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addTensor_onnx__MatMul_279(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addNode__MatMul_5(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addNode__MatMul_5_post_reshape(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addNode__MatMul_5_output_0_nfc(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addNode__Add_7(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addNode__Add_7_output_0_ncf(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addTensor_post_attention_layernorm_weight(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addTensor_post_attention_layernorm_weight_bias(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addNode_rms_norm__Mul_11_output_0(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addTensor_onnx__MatMul_280(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addNode__MatMul_6(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addNode__MatMul_6_post_reshape(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addTensor_onnx__MatMul_281(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addNode__MatMul_7(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addNode__MatMul_7_post_reshape(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addNode__Sigmoid(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addNode__Mul_12(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addNode__Mul_13(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addTensor_onnx__MatMul_282(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addNode__MatMul_8(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addNode__MatMul_8_post_reshape(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addNode__MatMul_8_output_0_nfc(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);
  VALIDATE(addNode__Add_9(qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous), err);

  // Add all models to array to get graphsInfo
  QnnModel* models [] = {&qwen2_0_5b_layer0_decode_past128_flash_attention_head_contiguous};
