...
ModelError_t QnnModel_composeGraphs(
  ...
  constexpr const char* graphName = "tinyBlockQProjCustomMatMul";
  ...
  // q_proj lhs from tiny_llm_block prefill:
  // normalized hidden [1,32,256] reshaped to [1,1,32,256].
  uint32_t lhsDimensions[] = {1, 1, 32, 256};
  ...
  // q_proj weight [256,256] reshaped to [1,1,256,256].
  ...
  uint32_t outputDimensions[] = {1, 1, 32, 256};
  ...
  VALIDATE(
      model.addNode(
          QNN_OPCONFIG_VERSION_1,
          "MatMulQhpiHvx8RowFp32StoreMultithread_0",
