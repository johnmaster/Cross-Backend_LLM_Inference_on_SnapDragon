#!/usr/bin/env python3
"""Patch converter-generated prefill QNN source to use q_proj LHS tile-cache MatMul."""
...
DEFAULT_OUTPUT = ROOT / "generated" / "tiny_block_prefill_q_proj_lhs_tile_cache.cpp"
...
def main() -> int:
    ...
    text = text.replace(
        "/* Command Line used:",
        "/* Patched by tiny_llm_block_custom_matmul/tools/patch_prefill_q_proj_lhs_tile_cache.py\n"
        " * Replaces q_proj FullyConnected with MatMulQhpiHvx8RowLhsTileCacheFp32Store.\n"
        " */\n\n/* Command Line used:",
        1,
    )
