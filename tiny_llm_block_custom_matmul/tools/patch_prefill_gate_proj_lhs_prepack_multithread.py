#!/usr/bin/env python3
"""Patch prefill QNN source to use LHS-prepack multithread custom gate_proj MatMul."""
...
DEFAULT_OUTPUT = ROOT / "generated" / "tiny_block_prefill_gate_proj_lhs_prepack_multithread.cpp"
...
def main() -> int:
    ...
    text = text.replace(
        "/* Command Line used:",
        "/* Patched by tiny_llm_block_custom_matmul/tools/patch_prefill_gate_proj_lhs_prepack_multithread.py\n"
        " * Replaces gate_proj FullyConnected with MatMulQhpiHvx8RowLhsPrepackFp32StoreMultithread.\n"
        " */\n\n/* Command Line used:",
        1,
    )
