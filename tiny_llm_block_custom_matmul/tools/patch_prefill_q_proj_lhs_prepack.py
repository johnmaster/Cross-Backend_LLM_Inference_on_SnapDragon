#!/usr/bin/env python3
"""Patch prefill QNN source to use LHS-prepack custom q_proj MatMul."""
...
DEFAULT_OUTPUT = ROOT / "generated" / "tiny_block_prefill_q_proj_lhs_prepack.cpp"
...
def main() -> int:
    ...
    text = text.replace(
        "/* Command Line used:",
        "/* Patched by tiny_llm_block_custom_matmul/tools/patch_prefill_q_proj_lhs_prepack.py\n"
        " * Replaces q_proj FullyConnected with MatMulQhpiHvx8RowLhsPrepackFp32Store.\n"
        " */\n\n/* Command Line used:",
        1,
    )
