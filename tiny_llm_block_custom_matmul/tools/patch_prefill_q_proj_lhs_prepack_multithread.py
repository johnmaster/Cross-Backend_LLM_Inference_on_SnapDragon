#!/usr/bin/env python3
"""Patch prefill QNN source to use LHS-prepack multithread custom q_proj MatMul."""
...
DEFAULT_OUTPUT = ROOT / "generated" / "tiny_block_prefill_q_proj_lhs_prepack_multithread.cpp"


NEW_Q_PROJ_NODE = """static ModelError_t addNode__MatMul(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;

  /* Replaces q_proj FullyConnected with LHS-prepack custom HTP MatMul:
  ...
  VALIDATE(model.addNode(QNN_OPCONFIG_VERSION_1,
                         ...
                         "MatMulQhpiHvx8RowLhsPrepackFp32StoreMultithreadOpPackage",
...
def main() -> int:
    ...
    text = text.replace(
        "/* Command Line used:",
        "/* Patched by tiny_llm_block_custom_matmul/tools/patch_prefill_q_proj_lhs_prepack_multithread.py\n"
        " * Replaces q_proj FullyConnected with MatMulQhpiHvx8RowLhsPrepackFp32StoreMultithread.\n"
        " */\n\n/* Command Line used:",
        1,
    )
