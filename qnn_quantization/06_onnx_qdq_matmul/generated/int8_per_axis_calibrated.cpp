                           ...
                           (Qnn_Tensor_t) {
                               ...
                               {.v2= {
                                 ...
                                 .quantizeParams= { QNN_DEFINITION_DEFINED,
                                                    ...
                                                    {.scaleOffsetEncoding= {.scale= 0.0039213779382407665252685546875000000000f, .offset= -128}}},
                                 .rank= 4,
  ...
  Qnn_Tensor_t outputs_MatMul[] = {
    (Qnn_Tensor_t) {
          ...
          {.v2= {
            ...
            .quantizeParams= { QNN_DEFINITION_DEFINED,
                               QNN_QUANTIZATION_ENCODING_SCALE_OFFSET,
                               {.scaleOffsetEncoding= {.scale= 0.0315420515835285186767578125000000000000f, .offset= -124}}},
            .rank= 4,
...
ModelError_t QnnModel_composeGraphs(Qnn_BackendHandle_t backendHandle,
  ...
  /* model/graph for int8_per_axis_calibrated*/
  QnnModel int8_per_axis_calibrated;
  const QnnGraph_Config_t** graphConfigs = nullptr;
  VALIDATE(getQnnGraphConfigFromInfo("int8_per_axis_calibrated", graphsConfigInfo, numGraphsConfigInfo, graphConfigs), err);
  VALIDATE(int8_per_axis_calibrated.initialize(backendHandle, interface, contextHandle, "int8_per_axis_calibrated", debug, DO_GRAPH_NODE_VALIDATIONS, graphConfigs), err);
  VALIDATE(addTensor_lhs(int8_per_axis_calibrated), err);
  VALIDATE(addNode_lhs_nchw(int8_per_axis_calibrated), err);
  VALIDATE(addTensor_rhs_nchw(int8_per_axis_calibrated), err);
  VALIDATE(addNode_MatMul(int8_per_axis_calibrated), err);

  // Add all models to array to get graphsInfo
  QnnModel* models [] = {&int8_per_axis_calibrated};
