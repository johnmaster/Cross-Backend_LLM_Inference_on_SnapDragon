//==============================================================================
// Auto Generated Code for MatMulQhpiHvxOpPackage - QHPI Interface
//==============================================================================
...
// Forward declaration for MatMulQhpiHvx registration
extern void register_matmulqhpihvx_ops();

// External declarations for operator infos from individual operator files
extern QHPI_OpInfo_v1 matmulqhpihvxOpInfo;

// op package info
const char* const sg_packageName = "MatMulQhpiHvxOpPackage";  // package name passed in as compile flag

static std::array<const char*, 1> sg_opNames{{"MatMulQhpiHvx"}};
 ...
 * can be set by Qnn_ErrorHandle_t MatMulQhpiHvxOpPackageLogSetLevel(QnnLog_Level_t maxLogLevel)
 */
/*
...
Qnn_ErrorHandle_t MatMulQhpiHvxOpPackageInit(QnnOpPackage_GlobalInfrastructure_t infrastructure) {
...
Qnn_ErrorHandle_t MatMulQhpiHvxOpPackageGetInfo(const QnnOpPackage_Info_t** info) {
...
Qnn_ErrorHandle_t MatMulQhpiHvxOpPackageLogInitialize(QnnLog_Callback_t callback, QnnLog_Level_t maxLogLevel) {
...
Qnn_ErrorHandle_t MatMulQhpiHvxOpPackageLogSetLevel(QnnLog_Level_t maxLogLevel) {
    if (maxLogLevel < QNN_LOG_LEVEL_ERROR) return QNN_LOG_ERROR_INVALID_ARGUMENT;
    sg_maxLogLevel = maxLogLevel;
    return QNN_SUCCESS;
}

Qnn_ErrorHandle_t MatMulQhpiHvxOpPackageLogTerminate() {
...
Qnn_ErrorHandle_t MatMulQhpiHvxOpPackageValidateOpConfig (Qnn_OpConfig_t opConfig){
     ...
     */
    if (std::string(opConfig.v1.typeName) == "MatMulQhpiHvx"){
 ...
 * (version 1.3.0) Qnn_ErrorHandle_t MatMulQhpiHvxOpPackageCreateKernels (QnnOpPackage_GraphInfrastructure_t
 * graphInfrastructure, QnnOpPackage_Node_t node, QnnOpPackage_Kernel_t** kernels, uint32_t*
 * numKernels)
 * (version 1.3.0) Qnn_ErrorHandle_t MatMulQhpiHvxOpPackageFreeKernels (QnnOpPackage_Kernel_t* kernels)
 *
 * (version 1.4.0) Qnn_ErrorHandle_t MatMulQhpiHvxOpPackageCreateOpImpl (QnnOpPackage_GraphInfrastructure_t
 * graphInfrastructure, QnnOpPackage_Node_t node, QnnOpPackage_OpImpl_t* opImpl)
 *(version 1.4.0) Qnn_ErrorHandle_t MatMulQhpiHvxOpPackageFreeOpImpl (QnnOpPackage_OpImpl_t opImpl)
 */

Qnn_ErrorHandle_t MatMulQhpiHvxOpPackageTerminate() {
if (!sg_packageInitialized) return QNN_OP_PACKAGE_ERROR_LIBRARY_NOT_INITIALIZED;
...
/* latest version */
Qnn_ErrorHandle_t MatMulQhpiHvxOpPackageInterfaceProvider(QnnOpPackage_Interface_t* interface) {
  if (!interface) return QNN_OP_PACKAGE_ERROR_INVALID_ARGUMENT;
  interface->interfaceVersion      = {1, 4, 0};
  interface->v1_4.init             = MatMulQhpiHvxOpPackageInit;
  interface->v1_4.terminate        = MatMulQhpiHvxOpPackageTerminate;
  interface->v1_4.getInfo          = MatMulQhpiHvxOpPackageGetInfo;
  interface->v1_4.validateOpConfig = MatMulQhpiHvxOpPackageValidateOpConfig;
  interface->v1_4.createOpImpl     = nullptr;
  interface->v1_4.freeOpImpl       = nullptr;
  interface->v1_4.logInitialize    = MatMulQhpiHvxOpPackageLogInitialize;
  interface->v1_4.logSetLevel      = MatMulQhpiHvxOpPackageLogSetLevel;
  interface->v1_4.logTerminate     = MatMulQhpiHvxOpPackageLogTerminate;
  return QNN_SUCCESS;
}

// Implementation of qhpi_init function
const char* qhpi_init() {
    register_matmulqhpihvx_ops();
