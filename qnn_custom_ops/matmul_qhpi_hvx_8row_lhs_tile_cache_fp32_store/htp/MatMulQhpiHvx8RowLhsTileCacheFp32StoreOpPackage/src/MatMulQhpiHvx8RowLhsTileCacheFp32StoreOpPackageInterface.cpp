//==============================================================================
// Auto Generated Code for MatMulQhpiHvx8RowLhsTileCacheFp32StoreOpPackage - QHPI Interface
//==============================================================================
...
// Forward declaration for MatMulQhpiHvx8RowLhsTileCacheFp32Store registration
extern void register_matmulqhpihvx8rowlhstilecachefp32store_ops();

// External declarations for operator infos from individual operator files
extern QHPI_OpInfo_v1 matmulqhpihvx8rowlhstilecachefp32storeOpInfo;

// op package info
const char* const sg_packageName = "MatMulQhpiHvx8RowLhsTileCacheFp32StoreOpPackage";  // package name passed in as compile flag

static std::array<const char*, 1> sg_opNames{{"MatMulQhpiHvx8RowLhsTileCacheFp32Store"}};
 ...
 * can be set by Qnn_ErrorHandle_t MatMulQhpiHvx8RowLhsTileCacheFp32StoreOpPackageLogSetLevel(QnnLog_Level_t maxLogLevel)
 */
/*
...
Qnn_ErrorHandle_t MatMulQhpiHvx8RowLhsTileCacheFp32StoreOpPackageInit(QnnOpPackage_GlobalInfrastructure_t infrastructure) {
...
Qnn_ErrorHandle_t MatMulQhpiHvx8RowLhsTileCacheFp32StoreOpPackageGetInfo(const QnnOpPackage_Info_t** info) {
...
Qnn_ErrorHandle_t MatMulQhpiHvx8RowLhsTileCacheFp32StoreOpPackageLogInitialize(QnnLog_Callback_t callback, QnnLog_Level_t maxLogLevel) {
...
Qnn_ErrorHandle_t MatMulQhpiHvx8RowLhsTileCacheFp32StoreOpPackageLogSetLevel(QnnLog_Level_t maxLogLevel) {
    if (maxLogLevel < QNN_LOG_LEVEL_ERROR) return QNN_LOG_ERROR_INVALID_ARGUMENT;
    sg_maxLogLevel = maxLogLevel;
    return QNN_SUCCESS;
}

Qnn_ErrorHandle_t MatMulQhpiHvx8RowLhsTileCacheFp32StoreOpPackageLogTerminate() {
...
Qnn_ErrorHandle_t MatMulQhpiHvx8RowLhsTileCacheFp32StoreOpPackageValidateOpConfig (Qnn_OpConfig_t opConfig){
     ...
     */
    if (std::string(opConfig.v1.typeName) == "MatMulQhpiHvx8RowLhsTileCacheFp32Store"){
        const bool validNumInputs = opConfig.v1.numOfInputs == 2 || opConfig.v1.numOfInputs == 3;
        if (opConfig.v1.numOfParams != 0 || !validNumInputs || opConfig.v1.numOfOutputs != 1){
          return QNN_OP_PACKAGE_ERROR_VALIDATION_FAILURE;
        }
    }
    else{
 ...
 * (version 1.3.0) Qnn_ErrorHandle_t MatMulQhpiHvx8RowLhsTileCacheFp32StoreOpPackageCreateKernels (QnnOpPackage_GraphInfrastructure_t
 * graphInfrastructure, QnnOpPackage_Node_t node, QnnOpPackage_Kernel_t** kernels, uint32_t*
 * numKernels)
 * (version 1.3.0) Qnn_ErrorHandle_t MatMulQhpiHvx8RowLhsTileCacheFp32StoreOpPackageFreeKernels (QnnOpPackage_Kernel_t* kernels)
 *
 * (version 1.4.0) Qnn_ErrorHandle_t MatMulQhpiHvx8RowLhsTileCacheFp32StoreOpPackageCreateOpImpl (QnnOpPackage_GraphInfrastructure_t
 * graphInfrastructure, QnnOpPackage_Node_t node, QnnOpPackage_OpImpl_t* opImpl)
 *(version 1.4.0) Qnn_ErrorHandle_t MatMulQhpiHvx8RowLhsTileCacheFp32StoreOpPackageFreeOpImpl (QnnOpPackage_OpImpl_t opImpl)
 */

Qnn_ErrorHandle_t MatMulQhpiHvx8RowLhsTileCacheFp32StoreOpPackageTerminate() {
if (!sg_packageInitialized) return QNN_OP_PACKAGE_ERROR_LIBRARY_NOT_INITIALIZED;
...
/* latest version */
Qnn_ErrorHandle_t MatMulQhpiHvx8RowLhsTileCacheFp32StoreOpPackageInterfaceProvider(QnnOpPackage_Interface_t* interface) {
  if (!interface) return QNN_OP_PACKAGE_ERROR_INVALID_ARGUMENT;
  interface->interfaceVersion      = {1, 4, 0};
  interface->v1_4.init             = MatMulQhpiHvx8RowLhsTileCacheFp32StoreOpPackageInit;
  interface->v1_4.terminate        = MatMulQhpiHvx8RowLhsTileCacheFp32StoreOpPackageTerminate;
  interface->v1_4.getInfo          = MatMulQhpiHvx8RowLhsTileCacheFp32StoreOpPackageGetInfo;
  interface->v1_4.validateOpConfig = MatMulQhpiHvx8RowLhsTileCacheFp32StoreOpPackageValidateOpConfig;
  interface->v1_4.createOpImpl     = nullptr;
  interface->v1_4.freeOpImpl       = nullptr;
  interface->v1_4.logInitialize    = MatMulQhpiHvx8RowLhsTileCacheFp32StoreOpPackageLogInitialize;
  interface->v1_4.logSetLevel      = MatMulQhpiHvx8RowLhsTileCacheFp32StoreOpPackageLogSetLevel;
  interface->v1_4.logTerminate     = MatMulQhpiHvx8RowLhsTileCacheFp32StoreOpPackageLogTerminate;
  return QNN_SUCCESS;
}

// Implementation of qhpi_init function
const char* qhpi_init() {
    register_matmulqhpihvx8rowlhstilecachefp32store_ops();
