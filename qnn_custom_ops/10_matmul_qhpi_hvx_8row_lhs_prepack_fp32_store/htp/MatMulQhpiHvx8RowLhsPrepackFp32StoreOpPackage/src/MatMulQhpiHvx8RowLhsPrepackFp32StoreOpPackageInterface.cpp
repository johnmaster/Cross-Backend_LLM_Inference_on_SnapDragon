//==============================================================================
// Auto Generated Code for MatMulQhpiHvx8RowLhsPrepackFp32StoreOpPackage - QHPI Interface
//==============================================================================
...
// Forward declaration for MatMulQhpiHvx8RowLhsPrepackFp32Store registration
extern void register_matmulqhpihvx8rowlhsprepackfp32store_ops();

// External declarations for operator infos from individual operator files
extern QHPI_OpInfo_v1 matmulqhpihvx8rowlhsprepackfp32storeOpInfo;

// op package info
const char* const sg_packageName = "MatMulQhpiHvx8RowLhsPrepackFp32StoreOpPackage";  // package name passed in as compile flag
 ...
 * can be set by Qnn_ErrorHandle_t MatMulQhpiHvx8RowLhsPrepackFp32StoreOpPackageLogSetLevel(QnnLog_Level_t maxLogLevel)
 */
/*
...
Qnn_ErrorHandle_t MatMulQhpiHvx8RowLhsPrepackFp32StoreOpPackageInit(QnnOpPackage_GlobalInfrastructure_t infrastructure) {
...
Qnn_ErrorHandle_t MatMulQhpiHvx8RowLhsPrepackFp32StoreOpPackageGetInfo(const QnnOpPackage_Info_t** info) {
...
Qnn_ErrorHandle_t MatMulQhpiHvx8RowLhsPrepackFp32StoreOpPackageLogInitialize(QnnLog_Callback_t callback, QnnLog_Level_t maxLogLevel) {
...
Qnn_ErrorHandle_t MatMulQhpiHvx8RowLhsPrepackFp32StoreOpPackageLogSetLevel(QnnLog_Level_t maxLogLevel) {
    if (maxLogLevel < QNN_LOG_LEVEL_ERROR) return QNN_LOG_ERROR_INVALID_ARGUMENT;
    sg_maxLogLevel = maxLogLevel;
    return QNN_SUCCESS;
}

Qnn_ErrorHandle_t MatMulQhpiHvx8RowLhsPrepackFp32StoreOpPackageLogTerminate() {
...
Qnn_ErrorHandle_t MatMulQhpiHvx8RowLhsPrepackFp32StoreOpPackageValidateOpConfig (Qnn_OpConfig_t opConfig){
     ...
     */
    if (std::string(opConfig.v1.typeName) == "MatMulQhpiHvx8RowLhsPrepackFp32Store"){
 ...
 * (version 1.3.0) Qnn_ErrorHandle_t MatMulQhpiHvx8RowLhsPrepackFp32StoreOpPackageCreateKernels (QnnOpPackage_GraphInfrastructure_t
 * graphInfrastructure, QnnOpPackage_Node_t node, QnnOpPackage_Kernel_t** kernels, uint32_t*
 * numKernels)
 * (version 1.3.0) Qnn_ErrorHandle_t MatMulQhpiHvx8RowLhsPrepackFp32StoreOpPackageFreeKernels (QnnOpPackage_Kernel_t* kernels)
 *
 * (version 1.4.0) Qnn_ErrorHandle_t MatMulQhpiHvx8RowLhsPrepackFp32StoreOpPackageCreateOpImpl (QnnOpPackage_GraphInfrastructure_t
 * graphInfrastructure, QnnOpPackage_Node_t node, QnnOpPackage_OpImpl_t* opImpl)
 *(version 1.4.0) Qnn_ErrorHandle_t MatMulQhpiHvx8RowLhsPrepackFp32StoreOpPackageFreeOpImpl (QnnOpPackage_OpImpl_t opImpl)
 */

Qnn_ErrorHandle_t MatMulQhpiHvx8RowLhsPrepackFp32StoreOpPackageTerminate() {
if (!sg_packageInitialized) return QNN_OP_PACKAGE_ERROR_LIBRARY_NOT_INITIALIZED;
...
/* latest version */
Qnn_ErrorHandle_t MatMulQhpiHvx8RowLhsPrepackFp32StoreOpPackageInterfaceProvider(QnnOpPackage_Interface_t* interface) {
  if (!interface) return QNN_OP_PACKAGE_ERROR_INVALID_ARGUMENT;
  interface->interfaceVersion      = {1, 4, 0};
  interface->v1_4.init             = MatMulQhpiHvx8RowLhsPrepackFp32StoreOpPackageInit;
  interface->v1_4.terminate        = MatMulQhpiHvx8RowLhsPrepackFp32StoreOpPackageTerminate;
  interface->v1_4.getInfo          = MatMulQhpiHvx8RowLhsPrepackFp32StoreOpPackageGetInfo;
  interface->v1_4.validateOpConfig = MatMulQhpiHvx8RowLhsPrepackFp32StoreOpPackageValidateOpConfig;
  interface->v1_4.createOpImpl     = nullptr;
  interface->v1_4.freeOpImpl       = nullptr;
  interface->v1_4.logInitialize    = MatMulQhpiHvx8RowLhsPrepackFp32StoreOpPackageLogInitialize;
  interface->v1_4.logSetLevel      = MatMulQhpiHvx8RowLhsPrepackFp32StoreOpPackageLogSetLevel;
  interface->v1_4.logTerminate     = MatMulQhpiHvx8RowLhsPrepackFp32StoreOpPackageLogTerminate;
  return QNN_SUCCESS;
}

// Implementation of qhpi_init function
const char* qhpi_init() {
    register_matmulqhpihvx8rowlhsprepackfp32store_ops();
