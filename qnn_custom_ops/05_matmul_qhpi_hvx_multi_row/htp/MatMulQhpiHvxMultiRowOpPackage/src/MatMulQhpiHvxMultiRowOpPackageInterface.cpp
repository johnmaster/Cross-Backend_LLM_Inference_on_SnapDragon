//==============================================================================
// Auto Generated Code for MatMulQhpiHvxMultiRowOpPackage - QHPI Interface
//==============================================================================
...
// Forward declaration for MatMulQhpiHvxMultiRow registration
extern void register_matmulqhpihvxmultirow_ops();

// External declarations for operator infos from individual operator files
extern QHPI_OpInfo_v1 matmulqhpihvxmultirowOpInfo;

// op package info
const char* const sg_packageName = "MatMulQhpiHvxMultiRowOpPackage";  // package name passed in as compile flag

static std::array<const char*, 1> sg_opNames{{"MatMulQhpiHvxMultiRow"}};
 ...
 * can be set by Qnn_ErrorHandle_t MatMulQhpiHvxMultiRowOpPackageLogSetLevel(QnnLog_Level_t maxLogLevel)
 */
/*
...
Qnn_ErrorHandle_t MatMulQhpiHvxMultiRowOpPackageInit(QnnOpPackage_GlobalInfrastructure_t infrastructure) {
...
Qnn_ErrorHandle_t MatMulQhpiHvxMultiRowOpPackageGetInfo(const QnnOpPackage_Info_t** info) {
...
Qnn_ErrorHandle_t MatMulQhpiHvxMultiRowOpPackageLogInitialize(QnnLog_Callback_t callback, QnnLog_Level_t maxLogLevel) {
...
Qnn_ErrorHandle_t MatMulQhpiHvxMultiRowOpPackageLogSetLevel(QnnLog_Level_t maxLogLevel) {
    if (maxLogLevel < QNN_LOG_LEVEL_ERROR) return QNN_LOG_ERROR_INVALID_ARGUMENT;
    sg_maxLogLevel = maxLogLevel;
    return QNN_SUCCESS;
}

Qnn_ErrorHandle_t MatMulQhpiHvxMultiRowOpPackageLogTerminate() {
...
Qnn_ErrorHandle_t MatMulQhpiHvxMultiRowOpPackageValidateOpConfig (Qnn_OpConfig_t opConfig){
     ...
     */
    if (std::string(opConfig.v1.typeName) == "MatMulQhpiHvxMultiRow"){
 ...
 * (version 1.3.0) Qnn_ErrorHandle_t MatMulQhpiHvxMultiRowOpPackageCreateKernels (QnnOpPackage_GraphInfrastructure_t
 * graphInfrastructure, QnnOpPackage_Node_t node, QnnOpPackage_Kernel_t** kernels, uint32_t*
 * numKernels)
 * (version 1.3.0) Qnn_ErrorHandle_t MatMulQhpiHvxMultiRowOpPackageFreeKernels (QnnOpPackage_Kernel_t* kernels)
 *
 * (version 1.4.0) Qnn_ErrorHandle_t MatMulQhpiHvxMultiRowOpPackageCreateOpImpl (QnnOpPackage_GraphInfrastructure_t
 * graphInfrastructure, QnnOpPackage_Node_t node, QnnOpPackage_OpImpl_t* opImpl)
 *(version 1.4.0) Qnn_ErrorHandle_t MatMulQhpiHvxMultiRowOpPackageFreeOpImpl (QnnOpPackage_OpImpl_t opImpl)
 */

Qnn_ErrorHandle_t MatMulQhpiHvxMultiRowOpPackageTerminate() {
if (!sg_packageInitialized) return QNN_OP_PACKAGE_ERROR_LIBRARY_NOT_INITIALIZED;
...
/* latest version */
Qnn_ErrorHandle_t MatMulQhpiHvxMultiRowOpPackageInterfaceProvider(QnnOpPackage_Interface_t* interface) {
  if (!interface) return QNN_OP_PACKAGE_ERROR_INVALID_ARGUMENT;
  interface->interfaceVersion      = {1, 4, 0};
  interface->v1_4.init             = MatMulQhpiHvxMultiRowOpPackageInit;
  interface->v1_4.terminate        = MatMulQhpiHvxMultiRowOpPackageTerminate;
  interface->v1_4.getInfo          = MatMulQhpiHvxMultiRowOpPackageGetInfo;
  interface->v1_4.validateOpConfig = MatMulQhpiHvxMultiRowOpPackageValidateOpConfig;
  interface->v1_4.createOpImpl     = nullptr;
  interface->v1_4.freeOpImpl       = nullptr;
  interface->v1_4.logInitialize    = MatMulQhpiHvxMultiRowOpPackageLogInitialize;
  interface->v1_4.logSetLevel      = MatMulQhpiHvxMultiRowOpPackageLogSetLevel;
  interface->v1_4.logTerminate     = MatMulQhpiHvxMultiRowOpPackageLogTerminate;
  return QNN_SUCCESS;
}

// Implementation of qhpi_init function
const char* qhpi_init() {
    register_matmulqhpihvxmultirow_ops();
