...
```bash
python3 qnn_custom_ops/17_qwen_flash_attention_hvx/tools/online_softmax_reference.py \
  --kv-length 129 \
  --block-size 32

python3 qnn_custom_ops/17_qwen_flash_attention_hvx/tools/generate_fixture.py
```
...
```bash
bash qnn_custom_ops/17_qwen_flash_attention_hvx/scripts/build.sh
```
...
```bash
bash qnn_custom_ops/17_qwen_flash_attention_hvx/scripts/build_qwen_graph.sh
```
...
qnn_custom_ops/17_qwen_flash_attention_hvx/model_libs/aarch64-android/
...
```bash
python3 qnn_custom_ops/17_qwen_flash_attention_hvx/tools/compare_device_output.py
```
