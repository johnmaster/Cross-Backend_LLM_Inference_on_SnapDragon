//==============================================================================
// Auto Generated Code for MatMulQhpiHvx8RowLhsPrepackFp32StoreMultithreadOpPackage - QHPI Interface
//==============================================================================
...
// Forward declaration for MatMulQhpiHvx8RowLhsPrepackFp32StoreMultithread registration
extern void register_matmulqhpihvx8rowlhsprepackfp32storemultithread_ops();

// External declarations for operator infos from individual operator files
extern QHPI_OpInfo_v1 matmulqhpihvx8rowlhsprepackfp32storemultithreadOpInfo;

// op package info
const char* const sg_packageName = "MatMulQhpiHvx8RowLhsPrepackFp32StoreMultithreadOpPackage";  // package name passed in as compile flag

static std::array<const char*, 2> sg_opNames{{
    "MatMulQhpiHvx8RowLhsPrepackFp32StoreMultithread",
 ...
 * can be set by Qnn_ErrorHandle_t MatMulQhpiHvx8RowLhsPrepackFp32StoreMultithreadOpPackageLogSetLevel(QnnLog_Level_t maxLogLevel)
 */
/*
...
Qnn_ErrorHandle_t MatMulQhpiHvx8RowLhsPrepackFp32StoreMultithreadOpPackageInit(QnnOpPackage_GlobalInfrastructure_t infrastructure) {
...
Qnn_ErrorHandle_t MatMulQhpiHvx8RowLhsPrepackFp32StoreMultithreadOpPackageGetInfo(const QnnOpPackage_Info_t** info) {
...
Qnn_ErrorHandle_t MatMulQhpiHvx8RowLhsPrepackFp32StoreMultithreadOpPackageLogInitialize(QnnLog_Callback_t callback, QnnLog_Level_t maxLogLevel) {
...
Qnn_ErrorHandle_t MatMulQhpiHvx8RowLhsPrepackFp32StoreMultithreadOpPackageLogSetLevel(QnnLog_Level_t maxLogLevel) {
    if (maxLogLevel < QNN_LOG_LEVEL_ERROR) return QNN_LOG_ERROR_INVALID_ARGUMENT;
    sg_maxLogLevel = maxLogLevel;
    return QNN_SUCCESS;
}

Qnn_ErrorHandle_t MatMulQhpiHvx8RowLhsPrepackFp32StoreMultithreadOpPackageLogTerminate() {
...
Qnn_ErrorHandle_t MatMulQhpiHvx8RowLhsPrepackFp32StoreMultithreadOpPackageValidateOpConfig (Qnn_OpConfig_t opConfig){
     ...
     */
    if (std::string(opConfig.v1.typeName) == "MatMulQhpiHvx8RowLhsPrepackFp32StoreMultithread"){
        if (opConfig.v1.numOfParams != 0 || opConfig.v1.numOfInputs != 2 || opConfig.v1.numOfOutputs != 1){
          return QNN_OP_PACKAGE_ERROR_VALIDATION_FAILURE;
        }
    }
    else if (std::string(opConfig.v1.typeName) == "MatMulQhpiHvxPackLhs"){
 ...
 * (version 1.3.0) Qnn_ErrorHandle_t MatMulQhpiHvx8RowLhsPrepackFp32StoreMultithreadOpPackageCreateKernels (QnnOpPackage_GraphInfrastructure_t
 * graphInfrastructure, QnnOpPackage_Node_t node, QnnOpPackage_Kernel_t** kernels, uint32_t*
 * numKernels)
 * (version 1.3.0) Qnn_ErrorHandle_t MatMulQhpiHvx8RowLhsPrepackFp32StoreMultithreadOpPackageFreeKernels (QnnOpPackage_Kernel_t* kernels)
 *
 * (version 1.4.0) Qnn_ErrorHandle_t MatMulQhpiHvx8RowLhsPrepackFp32StoreMultithreadOpPackageCreateOpImpl (QnnOpPackage_GraphInfrastructure_t
 * graphInfrastructure, QnnOpPackage_Node_t node, QnnOpPackage_OpImpl_t* opImpl)
 *(version 1.4.0) Qnn_ErrorHandle_t MatMulQhpiHvx8RowLhsPrepackFp32StoreMultithreadOpPackageFreeOpImpl (QnnOpPackage_OpImpl_t opImpl)
 */

Qnn_ErrorHandle_t MatMulQhpiHvx8RowLhsPrepackFp32StoreMultithreadOpPackageTerminate() {
if (!sg_packageInitialized) return QNN_OP_PACKAGE_ERROR_LIBRARY_NOT_INITIALIZED;
...
/* latest version */
Qnn_ErrorHandle_t MatMulQhpiHvx8RowLhsPrepackFp32StoreMultithreadOpPackageInterfaceProvider(QnnOpPackage_Interface_t* interface) {
  if (!interface) return QNN_OP_PACKAGE_ERROR_INVALID_ARGUMENT;
  interface->interfaceVersion      = {1, 4, 0};
  interface->v1_4.init             = MatMulQhpiHvx8RowLhsPrepackFp32StoreMultithreadOpPackageInit;
  interface->v1_4.terminate        = MatMulQhpiHvx8RowLhsPrepackFp32StoreMultithreadOpPackageTerminate;
  interface->v1_4.getInfo          = MatMulQhpiHvx8RowLhsPrepackFp32StoreMultithreadOpPackageGetInfo;
  interface->v1_4.validateOpConfig = MatMulQhpiHvx8RowLhsPrepackFp32StoreMultithreadOpPackageValidateOpConfig;
  interface->v1_4.createOpImpl     = nullptr;
  interface->v1_4.freeOpImpl       = nullptr;
  interface->v1_4.logInitialize    = MatMulQhpiHvx8RowLhsPrepackFp32StoreMultithreadOpPackageLogInitialize;
  interface->v1_4.logSetLevel      = MatMulQhpiHvx8RowLhsPrepackFp32StoreMultithreadOpPackageLogSetLevel;
  interface->v1_4.logTerminate     = MatMulQhpiHvx8RowLhsPrepackFp32StoreMultithreadOpPackageLogTerminate;
  return QNN_SUCCESS;
}

// Implementation of qhpi_init function
const char* qhpi_init() {
    register_matmulqhpihvx8rowlhsprepackfp32storemultithread_ops();
