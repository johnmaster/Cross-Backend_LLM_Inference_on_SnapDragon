...
本目录基于
`../10_matmul_qhpi_hvx_8row_lhs_prepack_fp32_store`，验证把 LHS 预转换和
...
```bash
PKG=qnn_custom_ops/14_matmul_qhpi_hvx_8row_lhs_prepack_fp32_store_multithread/htp/MatMulQhpiHvx8RowLhsPrepackFp32StoreMultithreadOpPackage
...
/home/lingbok/Qualcomm/qairt/2.47.0.260601/bin/x86_64-linux-clang/qnn-model-lib-generator \
  -c qnn_custom_ops/14_matmul_qhpi_hvx_8row_lhs_prepack_fp32_store_multithread/model/custom_matmul_qhpi_hvx_8row_lhs_prepack_fp32_store_multithread_model.cpp \
  -t aarch64-android \
  -l custom_matmul_qhpi_hvx_8row_lhs_prepack_fp32_store_multithread_model \
  -o qnn_custom_ops/14_matmul_qhpi_hvx_8row_lhs_prepack_fp32_store_multithread/model_libs
```
