//==============================================================================
// Auto Generated Code for MatMulQhpiHvx8RowLhsPrepackFp32StoreMultithread - QHPI Implementation
...
#define MATMUL_QHPI_HVX_8ROW_LHS_PREPACK_FP32_STORE_MULTITHREAD_INTRINSICS 1
#endif

// Forward declarations for MatMulQhpiHvx8RowLhsPrepackFp32StoreMultithread kernel matmulqhpihvx8rowlhsprepackfp32storemultithread_float_16_
static uint32_t matmulqhpihvx8rowlhsprepackfp32storemultithread_float_16_Execute(QHPI_RuntimeHandle *handle,
                                      uint32_t num_outputs, QHPI_Tensor **outputs,
                                      uint32_t num_inputs, const QHPI_Tensor *const *inputs);
static float matmulqhpihvx8rowlhsprepackfp32storemultithread_float_16_CostFunc(const uint32_t num_inputs, const QHPI_Tensor *const *inputs);

// Common forward declarations for MatMulQhpiHvx8RowLhsPrepackFp32StoreMultithread
static const QHPI_Op* matmulqhpihvx8rowlhsprepackfp32storemultithreadEarlyRewrite(const QHPI_Op *op);
static QHPI_Shape matmulqhpihvx8rowlhsprepackfp32storemultithreadShapeRequired(const QHPI_Op *op);
static QHPI_Shape matmulqhpihvx8rowlhsprepackfp32storemultithreadShapeLegal(const QHPI_Op *op, const QHPI_Shape* shape);
static const QHPI_Op* matmulqhpihvx8rowlhsprepackfp32storemultithreadBuildTile(const QHPI_Op *op, const QHPI_Shape* start, const QHPI_Shape* extent);
static const QHPI_Op* matmulqhpihvx8rowlhsprepackfp32storemultithreadLateRewrite(const QHPI_Op *op);

static inline float matmulqhpihvx8rowlhsprepackfp32storemultithreadScalarDot(const int16_t *lhs,
                                           const __fp16 *rhs,
                                           uint64_t lhs_base,
                                           uint64_t rhs_base,
                                           uint32_t k,
...
#if MATMUL_QHPI_HVX_8ROW_LHS_PREPACK_FP32_STORE_MULTITHREAD_INTRINSICS
static inline HVX_Vector
matmulqhpihvx8rowlhsprepackfp32storemultithreadConvert64Fp16ToQ13(
    const __fp16 *values) {
...
static inline HVX_Vector
matmulqhpihvx8rowlhsprepackfp32storemultithreadConvertQ26ToFp32(HVX_Vector values) {
...
static inline void matmulqhpihvx8rowlhsprepackfp32storemultithreadCompute1x64Hvx(const int16_t *lhs,
                                                       const __fp16 *rhs,
                                                       float *output,
                                                       uint64_t lhs_base,
                                                       uint64_t rhs_base,
                                                       ...
                                                       uint32_t n,
                                                       uint32_t col) {
#if defined(MATMUL_QHPI_HVX_8ROW_LHS_PREPACK_FP32_STORE_MULTITHREAD_DEBUG_STORE_RHS)
  (void)lhs;
  (void)lhs_base;
  (void)k;
  ...
  const HVX_Vector even =
      matmulqhpihvx8rowlhsprepackfp32storemultithreadConvertQ26ToFp32(Q6_V_lo_W(acc));
  const HVX_Vector odd =
      matmulqhpihvx8rowlhsprepackfp32storemultithreadConvertQ26ToFp32(Q6_V_hi_W(acc));
...
static inline void matmulqhpihvx8rowlhsprepackfp32storemultithreadCompute8x64Hvx(
    const int16_t *lhs,
    const __fp16 *rhs,
    float *output,
    uint64_t lhs_base,
  ...
  for (uint32_t row = 0; row < 8; ++row) {
    ...
    const HVX_Vector even = matmulqhpihvx8rowlhsprepackfp32storemultithreadConvertQ26ToFp32(
        Q6_V_lo_W(accumulators[row]));
    const HVX_Vector odd = matmulqhpihvx8rowlhsprepackfp32storemultithreadConvertQ26ToFp32(
...
/*
 * QHPI Registration using hexnn_ffi.h API for MatMulQhpiHvx8RowLhsPrepackFp32StoreMultithread
 * Multiple kernels for different data type combinations
 */


// Input tensor signatures for MatMulQhpiHvx8RowLhsPrepackFp32StoreMultithread kernel matmulqhpihvx8rowlhsprepackfp32storemultithread_float_16_
// Includes both regular inputs and parameters as inputs
static QHPI_Tensor_Signature_v1 matmulqhpihvx8rowlhsprepackfp32storemultithread_float_16_InputSignatures[] = {
...
static QHPI_Tensor_Signature_v1 matmulqhpihvx8rowlhsprepackfp32storemultithread_float_16_OutputSignatures[] = {
...
// Kernel definition for MatMulQhpiHvx8RowLhsPrepackFp32StoreMultithread kernel matmulqhpihvx8rowlhsprepackfp32storemultithread_float_16_
static QHPI_Kernel_v1 matmulqhpihvx8rowlhsprepackfp32storemultithread_float_16_Kernel = {
    .function_name = "matmulqhpihvx8rowlhsprepackfp32storemultithread_float_16_Execute",
    .function = matmulqhpihvx8rowlhsprepackfp32storemultithread_float_16_Execute,
    ...
    .min_inputs = 2,
    .input_signature = matmulqhpihvx8rowlhsprepackfp32storemultithread_float_16_InputSignatures,
    .min_outputs = 1,
    .output_signature = matmulqhpihvx8rowlhsprepackfp32storemultithread_float_16_OutputSignatures,
    .cost_function = matmulqhpihvx8rowlhsprepackfp32storemultithread_float_16_CostFunc,
    .sync_block_size = 0,
...
// Array of all kernels for MatMulQhpiHvx8RowLhsPrepackFp32StoreMultithread
static QHPI_Kernel_v1 matmulqhpihvx8rowlhsprepackfp32storemultithreadKernels[] = {

    matmulqhpihvx8rowlhsprepackfp32storemultithread_float_16_Kernel
};

// Operator info for MatMulQhpiHvx8RowLhsPrepackFp32StoreMultithread - exported for package registration
QHPI_OpInfo_v1 matmulqhpihvx8rowlhsprepackfp32storemultithreadOpInfo = {
    .name = THIS_PKG_NAME_STR "::" "MatMulQhpiHvx8RowLhsPrepackFp32StoreMultithread",
    .num_kernels = 1,
    .kernels = matmulqhpihvx8rowlhsprepackfp32storemultithreadKernels,
    .early_rewrite = matmulqhpihvx8rowlhsprepackfp32storemultithreadEarlyRewrite,
    .shape_required = matmulqhpihvx8rowlhsprepackfp32storemultithreadShapeRequired,
    .shape_legalized = matmulqhpihvx8rowlhsprepackfp32storemultithreadShapeLegal,
    .build_tile = matmulqhpihvx8rowlhsprepackfp32storemultithreadBuildTile,
    .late_rewrite = matmulqhpihvx8rowlhsprepackfp32storemultithreadLateRewrite
};


/* QHPI execute function implementation for MatMulQhpiHvx8RowLhsPrepackFp32StoreMultithread kernel matmulqhpihvx8rowlhsprepackfp32storemultithread_float_16_ */
static uint32_t matmulqhpihvx8rowlhsprepackfp32storemultithread_float_16_Execute(
  ...
  // Self-slicing assigns disjoint row tiles to HVX workers. PackLhs has already
  // converted LHS to Q13, so this kernel only slices the MatMul work.
  for (uint32_t b = 0; b < batch; ++b) {
...
#if MATMUL_QHPI_HVX_8ROW_LHS_PREPACK_FP32_STORE_MULTITHREAD_INTRINSICS && \
    !defined(MATMUL_QHPI_HVX_8ROW_LHS_PREPACK_FP32_STORE_MULTITHREAD_FORCE_SCALAR)
      full_rows = m - (m % 8);
      for (uint32_t row = slice * 8;
        ...
        uint32_t col = 0;
        for (; col + 64 <= n; col += 64) {
          matmulqhpihvx8rowlhsprepackfp32storemultithreadCompute8x64Hvx(
        ...
        for (; col < n; ++col) {
          for (uint32_t tile_row = 0; tile_row < 8; ++tile_row) {
            ...
            output[tile_output_base + col] =
                matmulqhpihvx8rowlhsprepackfp32storemultithreadScalarDot(
    ...
    !defined(MATMUL_QHPI_HVX_8ROW_LHS_PREPACK_FP32_STORE_MULTITHREAD_FORCE_SCALAR)
        for (; col + 64 <= n; col += 64) {
          matmulqhpihvx8rowlhsprepackfp32storemultithreadCompute1x64Hvx(
              lhs, rhs, output, lhs_base, rhs_base, output_base, k, n, col);
        }
#endif
        for (; col < n; ++col) {
...
{
  /*
   * Cost estimation function for MatMulQhpiHvx8RowLhsPrepackFp32StoreMultithread kernel matmulqhpihvx8rowlhsprepackfp32storemultithread_float_16_
...
/*
 * Common stub implementations for MatMulQhpiHvx8RowLhsPrepackFp32StoreMultithread QHPI_OpInfo functions
...
{
  /*
   * Early rewrite function for MatMulQhpiHvx8RowLhsPrepackFp32StoreMultithread
...
{
  /*
   * Shape required function for MatMulQhpiHvx8RowLhsPrepackFp32StoreMultithread
...
{
  /*
   * Shape legal function for MatMulQhpiHvx8RowLhsPrepackFp32StoreMultithread
...
{
  /*
   * Build tile function for MatMulQhpiHvx8RowLhsPrepackFp32StoreMultithread
...
{
  /*
   * Late rewrite function for MatMulQhpiHvx8RowLhsPrepackFp32StoreMultithread
...
// Array of all MatMulQhpiHvx8RowLhsPrepackFp32StoreMultithread operations for registration
extern QHPI_OpInfo_v1 matmulqhpihvxpacklhsOpInfo;

static QHPI_OpInfo_v1 matmulqhpihvx8rowlhsprepackfp32storemultithread_ops[] = {
    matmulqhpihvx8rowlhsprepackfp32storemultithreadOpInfo,
    matmulqhpihvxpacklhsOpInfo,
};

// Registration function for MatMulQhpiHvx8RowLhsPrepackFp32StoreMultithread operations
extern "C" void register_matmulqhpihvx8rowlhsprepackfp32storemultithread_ops()
{
    qhpi_register_ops_v1(sizeof(matmulqhpihvx8rowlhsprepackfp32storemultithread_ops) / sizeof(matmulqhpihvx8rowlhsprepackfp32storemultithread_ops[0]), matmulqhpihvx8rowlhsprepackfp32storemultithread_ops, THIS_PKG_NAME_STR);
}
