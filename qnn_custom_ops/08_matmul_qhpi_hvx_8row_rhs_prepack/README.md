...
本目录在 `../07_matmul_qhpi_hvx_8row_vector_convert` 基础上，将 RHS 转换拆成
独立 QHPI Op：
...
```text
Directory:
  08_matmul_qhpi_hvx_8row_rhs_prepack
...
```bash
PKG=qnn_custom_ops/08_matmul_qhpi_hvx_8row_rhs_prepack/htp/MatMulQhpiHvx8RowRhsPrepackOpPackage
```
...
/home/lingbok/Qualcomm/qairt/2.47.0.260601/bin/x86_64-linux-clang/qnn-model-lib-generator \
  -c qnn_custom_ops/08_matmul_qhpi_hvx_8row_rhs_prepack/model/custom_matmul_qhpi_hvx_8row_rhs_prepack_model.cpp \
  -t aarch64-android \
  -l custom_matmul_qhpi_hvx_8row_rhs_prepack_model \
  -o qnn_custom_ops/08_matmul_qhpi_hvx_8row_rhs_prepack/model_libs
```
