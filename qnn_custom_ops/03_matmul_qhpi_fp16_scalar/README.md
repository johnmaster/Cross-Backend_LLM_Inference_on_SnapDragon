...
| `02_matmul_qhpi_scalar/` | QHPI | FP32 | 标量实现 | QHPI 基线 |
| `03_matmul_qhpi_fp16_scalar/` | QHPI | FP16 | 标量主线程 | FP16 正确性基线 |
| 后续 `04_matmul_qhpi_hvx/` | QHPI | FP16/FP32 | HVX | 向量化优化目标 |
...
qnn-op-package-generator \
  --config_path "$REPO/qnn_custom_ops/03_matmul_qhpi_fp16_scalar/config/MatMulQhpiFp16ScalarOpPackage.xml" \
  --output_path "$REPO/qnn_custom_ops/03_matmul_qhpi_fp16_scalar/htp" \
  --debug
```
