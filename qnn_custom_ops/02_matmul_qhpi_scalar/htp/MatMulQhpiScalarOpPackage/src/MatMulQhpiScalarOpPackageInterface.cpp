//==============================================================================
// Auto Generated Code for MatMulQhpiScalarOpPackage - QHPI Interface
//==============================================================================
...
// Forward declaration for MatMulQhpiScalar registration
extern void register_matmulqhpiscalar_ops();

// External declarations for operator infos from individual operator files
extern QHPI_OpInfo_v1 matmulqhpiscalarOpInfo;

// op package info
const char* const sg_packageName = "MatMulQhpiScalarOpPackage";  // package name passed in as compile flag

static std::array<const char*, 1> sg_opNames{{"MatMulQhpiScalar"}};
 ...
 * can be set by Qnn_ErrorHandle_t MatMulQhpiScalarOpPackageLogSetLevel(QnnLog_Level_t maxLogLevel)
 */
/*
...
Qnn_ErrorHandle_t MatMulQhpiScalarOpPackageInit(QnnOpPackage_GlobalInfrastructure_t infrastructure) {
...
Qnn_ErrorHandle_t MatMulQhpiScalarOpPackageGetInfo(const QnnOpPackage_Info_t** info) {
...
Qnn_ErrorHandle_t MatMulQhpiScalarOpPackageLogInitialize(QnnLog_Callback_t callback, QnnLog_Level_t maxLogLevel) {
...
Qnn_ErrorHandle_t MatMulQhpiScalarOpPackageLogSetLevel(QnnLog_Level_t maxLogLevel) {
    if (maxLogLevel < QNN_LOG_LEVEL_ERROR) return QNN_LOG_ERROR_INVALID_ARGUMENT;
    sg_maxLogLevel = maxLogLevel;
    return QNN_SUCCESS;
}

Qnn_ErrorHandle_t MatMulQhpiScalarOpPackageLogTerminate() {
...
Qnn_ErrorHandle_t MatMulQhpiScalarOpPackageValidateOpConfig (Qnn_OpConfig_t opConfig){
     ...
     */
    if (std::string(opConfig.v1.typeName) == "MatMulQhpiScalar"){
 ...
 * (version 1.3.0) Qnn_ErrorHandle_t MatMulQhpiScalarOpPackageCreateKernels (QnnOpPackage_GraphInfrastructure_t
 * graphInfrastructure, QnnOpPackage_Node_t node, QnnOpPackage_Kernel_t** kernels, uint32_t*
 * numKernels)
 * (version 1.3.0) Qnn_ErrorHandle_t MatMulQhpiScalarOpPackageFreeKernels (QnnOpPackage_Kernel_t* kernels)
 *
 * (version 1.4.0) Qnn_ErrorHandle_t MatMulQhpiScalarOpPackageCreateOpImpl (QnnOpPackage_GraphInfrastructure_t
 * graphInfrastructure, QnnOpPackage_Node_t node, QnnOpPackage_OpImpl_t* opImpl)
 *(version 1.4.0) Qnn_ErrorHandle_t MatMulQhpiScalarOpPackageFreeOpImpl (QnnOpPackage_OpImpl_t opImpl)
 */

Qnn_ErrorHandle_t MatMulQhpiScalarOpPackageTerminate() {
if (!sg_packageInitialized) return QNN_OP_PACKAGE_ERROR_LIBRARY_NOT_INITIALIZED;
...
/* latest version */
Qnn_ErrorHandle_t MatMulQhpiScalarOpPackageInterfaceProvider(QnnOpPackage_Interface_t* interface) {
  if (!interface) return QNN_OP_PACKAGE_ERROR_INVALID_ARGUMENT;
  interface->interfaceVersion      = {1, 4, 0};
  interface->v1_4.init             = MatMulQhpiScalarOpPackageInit;
  interface->v1_4.terminate        = MatMulQhpiScalarOpPackageTerminate;
  interface->v1_4.getInfo          = MatMulQhpiScalarOpPackageGetInfo;
  interface->v1_4.validateOpConfig = MatMulQhpiScalarOpPackageValidateOpConfig;
  interface->v1_4.createOpImpl     = nullptr;
  interface->v1_4.freeOpImpl       = nullptr;
  interface->v1_4.logInitialize    = MatMulQhpiScalarOpPackageLogInitialize;
  interface->v1_4.logSetLevel      = MatMulQhpiScalarOpPackageLogSetLevel;
  interface->v1_4.logTerminate     = MatMulQhpiScalarOpPackageLogTerminate;
  return QNN_SUCCESS;
}

// Implementation of qhpi_init function
const char* qhpi_init() {
    register_matmulqhpiscalar_ops();
