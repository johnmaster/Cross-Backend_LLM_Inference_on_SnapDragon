...
本目录是在 `../06_matmul_qhpi_hvx_multi_row_vector_convert` 基础上的累计优化：
...
```text
../06_matmul_qhpi_hvx_multi_row_vector_convert/README.md
```
...
```text
Directory:
  07_matmul_qhpi_hvx_8row_vector_convert
...
```bash
PKG=qnn_custom_ops/07_matmul_qhpi_hvx_8row_vector_convert/htp/MatMulQhpiHvx8RowVectorConvertOpPackage
```
...
/home/lingbok/Qualcomm/qairt/2.47.0.260601/bin/x86_64-linux-clang/qnn-model-lib-generator \
  -c qnn_custom_ops/07_matmul_qhpi_hvx_8row_vector_convert/model/custom_matmul_qhpi_hvx_8row_vector_convert_model.cpp \
  -t aarch64-android \
  -l custom_matmul_qhpi_hvx_8row_vector_convert_model \
  -o qnn_custom_ops/07_matmul_qhpi_hvx_8row_vector_convert/model_libs
```
