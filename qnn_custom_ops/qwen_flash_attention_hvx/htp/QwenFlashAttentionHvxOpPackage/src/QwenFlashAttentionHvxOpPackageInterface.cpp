//==============================================================================
// Auto Generated Code for QwenFlashAttentionHvxOpPackage - QHPI Interface
//==============================================================================
...
// Forward declaration for QwenGqaFlashAttentionFp32 registration
extern void register_qwengqaflashattentionfp32_ops();

// External declarations for operator infos from individual operator files
extern QHPI_OpInfo_v1 qwengqaflashattentionfp32OpInfo;

// op package info
const char* const sg_packageName = "QwenFlashAttentionHvxOpPackage";  // package name passed in as compile flag

static std::array<const char*, 1> sg_opNames{{"QwenGqaFlashAttentionFp32"}};
 ...
 * can be set by Qnn_ErrorHandle_t QwenFlashAttentionHvxOpPackageLogSetLevel(QnnLog_Level_t maxLogLevel)
 */
/*
...
Qnn_ErrorHandle_t QwenFlashAttentionHvxOpPackageInit(QnnOpPackage_GlobalInfrastructure_t infrastructure) {
...
Qnn_ErrorHandle_t QwenFlashAttentionHvxOpPackageGetInfo(const QnnOpPackage_Info_t** info) {
...
Qnn_ErrorHandle_t QwenFlashAttentionHvxOpPackageLogInitialize(QnnLog_Callback_t callback, QnnLog_Level_t maxLogLevel) {
...
Qnn_ErrorHandle_t QwenFlashAttentionHvxOpPackageLogSetLevel(QnnLog_Level_t maxLogLevel) {
    if (maxLogLevel < QNN_LOG_LEVEL_ERROR) return QNN_LOG_ERROR_INVALID_ARGUMENT;
    sg_maxLogLevel = maxLogLevel;
    return QNN_SUCCESS;
}

Qnn_ErrorHandle_t QwenFlashAttentionHvxOpPackageLogTerminate() {
...
Qnn_ErrorHandle_t QwenFlashAttentionHvxOpPackageValidateOpConfig (Qnn_OpConfig_t opConfig){
     ...
     */
    if (std::string(opConfig.v1.typeName) == "QwenGqaFlashAttentionFp32"){
 ...
 * (version 1.3.0) Qnn_ErrorHandle_t QwenFlashAttentionHvxOpPackageCreateKernels (QnnOpPackage_GraphInfrastructure_t
 * graphInfrastructure, QnnOpPackage_Node_t node, QnnOpPackage_Kernel_t** kernels, uint32_t*
 * numKernels)
 * (version 1.3.0) Qnn_ErrorHandle_t QwenFlashAttentionHvxOpPackageFreeKernels (QnnOpPackage_Kernel_t* kernels)
 *
 * (version 1.4.0) Qnn_ErrorHandle_t QwenFlashAttentionHvxOpPackageCreateOpImpl (QnnOpPackage_GraphInfrastructure_t
 * graphInfrastructure, QnnOpPackage_Node_t node, QnnOpPackage_OpImpl_t* opImpl)
 *(version 1.4.0) Qnn_ErrorHandle_t QwenFlashAttentionHvxOpPackageFreeOpImpl (QnnOpPackage_OpImpl_t opImpl)
 */

Qnn_ErrorHandle_t QwenFlashAttentionHvxOpPackageTerminate() {
if (!sg_packageInitialized) return QNN_OP_PACKAGE_ERROR_LIBRARY_NOT_INITIALIZED;
...
/* latest version */
Qnn_ErrorHandle_t QwenFlashAttentionHvxOpPackageInterfaceProvider(QnnOpPackage_Interface_t* interface) {
  if (!interface) return QNN_OP_PACKAGE_ERROR_INVALID_ARGUMENT;
  interface->interfaceVersion      = {1, 4, 0};
  interface->v1_4.init             = QwenFlashAttentionHvxOpPackageInit;
  interface->v1_4.terminate        = QwenFlashAttentionHvxOpPackageTerminate;
  interface->v1_4.getInfo          = QwenFlashAttentionHvxOpPackageGetInfo;
  interface->v1_4.validateOpConfig = QwenFlashAttentionHvxOpPackageValidateOpConfig;
  interface->v1_4.createOpImpl     = nullptr;
  interface->v1_4.freeOpImpl       = nullptr;
  interface->v1_4.logInitialize    = QwenFlashAttentionHvxOpPackageLogInitialize;
  interface->v1_4.logSetLevel      = QwenFlashAttentionHvxOpPackageLogSetLevel;
  interface->v1_4.logTerminate     = QwenFlashAttentionHvxOpPackageLogTerminate;
  return QNN_SUCCESS;
}

// Implementation of qhpi_init function
const char* qhpi_init() {
    register_qwengqaflashattentionfp32_ops();
