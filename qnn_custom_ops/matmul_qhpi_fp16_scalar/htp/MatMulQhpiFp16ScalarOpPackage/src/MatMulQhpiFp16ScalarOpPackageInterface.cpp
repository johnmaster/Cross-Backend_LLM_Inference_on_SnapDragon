//==============================================================================
// Auto Generated Code for MatMulQhpiFp16ScalarOpPackage - QHPI Interface
//==============================================================================
...
// Forward declaration for MatMulQhpiFp16Scalar registration
extern void register_matmulqhpifp16scalar_ops();

// External declarations for operator infos from individual operator files
extern QHPI_OpInfo_v1 matmulqhpifp16scalarOpInfo;

// op package info
const char* const sg_packageName = "MatMulQhpiFp16ScalarOpPackage";  // package name passed in as compile flag

static std::array<const char*, 1> sg_opNames{{"MatMulQhpiFp16Scalar"}};
 ...
 * can be set by Qnn_ErrorHandle_t MatMulQhpiFp16ScalarOpPackageLogSetLevel(QnnLog_Level_t maxLogLevel)
 */
/*
...
Qnn_ErrorHandle_t MatMulQhpiFp16ScalarOpPackageInit(QnnOpPackage_GlobalInfrastructure_t infrastructure) {
...
Qnn_ErrorHandle_t MatMulQhpiFp16ScalarOpPackageGetInfo(const QnnOpPackage_Info_t** info) {
...
Qnn_ErrorHandle_t MatMulQhpiFp16ScalarOpPackageLogInitialize(QnnLog_Callback_t callback, QnnLog_Level_t maxLogLevel) {
...
Qnn_ErrorHandle_t MatMulQhpiFp16ScalarOpPackageLogSetLevel(QnnLog_Level_t maxLogLevel) {
    if (maxLogLevel < QNN_LOG_LEVEL_ERROR) return QNN_LOG_ERROR_INVALID_ARGUMENT;
    sg_maxLogLevel = maxLogLevel;
    return QNN_SUCCESS;
}

Qnn_ErrorHandle_t MatMulQhpiFp16ScalarOpPackageLogTerminate() {
...
Qnn_ErrorHandle_t MatMulQhpiFp16ScalarOpPackageValidateOpConfig (Qnn_OpConfig_t opConfig){
     ...
     */
    if (std::string(opConfig.v1.typeName) == "MatMulQhpiFp16Scalar"){
 ...
 * (version 1.3.0) Qnn_ErrorHandle_t MatMulQhpiFp16ScalarOpPackageCreateKernels (QnnOpPackage_GraphInfrastructure_t
 * graphInfrastructure, QnnOpPackage_Node_t node, QnnOpPackage_Kernel_t** kernels, uint32_t*
 * numKernels)
 * (version 1.3.0) Qnn_ErrorHandle_t MatMulQhpiFp16ScalarOpPackageFreeKernels (QnnOpPackage_Kernel_t* kernels)
 *
 * (version 1.4.0) Qnn_ErrorHandle_t MatMulQhpiFp16ScalarOpPackageCreateOpImpl (QnnOpPackage_GraphInfrastructure_t
 * graphInfrastructure, QnnOpPackage_Node_t node, QnnOpPackage_OpImpl_t* opImpl)
 *(version 1.4.0) Qnn_ErrorHandle_t MatMulQhpiFp16ScalarOpPackageFreeOpImpl (QnnOpPackage_OpImpl_t opImpl)
 */

Qnn_ErrorHandle_t MatMulQhpiFp16ScalarOpPackageTerminate() {
if (!sg_packageInitialized) return QNN_OP_PACKAGE_ERROR_LIBRARY_NOT_INITIALIZED;
...
/* latest version */
Qnn_ErrorHandle_t MatMulQhpiFp16ScalarOpPackageInterfaceProvider(QnnOpPackage_Interface_t* interface) {
  if (!interface) return QNN_OP_PACKAGE_ERROR_INVALID_ARGUMENT;
  interface->interfaceVersion      = {1, 4, 0};
  interface->v1_4.init             = MatMulQhpiFp16ScalarOpPackageInit;
  interface->v1_4.terminate        = MatMulQhpiFp16ScalarOpPackageTerminate;
  interface->v1_4.getInfo          = MatMulQhpiFp16ScalarOpPackageGetInfo;
  interface->v1_4.validateOpConfig = MatMulQhpiFp16ScalarOpPackageValidateOpConfig;
  interface->v1_4.createOpImpl     = nullptr;
  interface->v1_4.freeOpImpl       = nullptr;
  interface->v1_4.logInitialize    = MatMulQhpiFp16ScalarOpPackageLogInitialize;
  interface->v1_4.logSetLevel      = MatMulQhpiFp16ScalarOpPackageLogSetLevel;
  interface->v1_4.logTerminate     = MatMulQhpiFp16ScalarOpPackageLogTerminate;
  return QNN_SUCCESS;
}

// Implementation of qhpi_init function
const char* qhpi_init() {
    register_matmulqhpifp16scalar_ops();
