 ...
 */
DECLARE_PKG_OPS_OPTS_LIST(PKG_MatMulCustom)
...
static std::array<const char*, 1> sg_opNames{{"MatMulCustom"}};
 ...
 * can be set by Qnn_ErrorHandle_t MatMulCustomOpPackageLogSetLevel(QnnLog_Level_t maxLogLevel)
 */
/*
...
Qnn_ErrorHandle_t MatMulCustomOpPackageInit(QnnOpPackage_GlobalInfrastructure_t infrastructure) {
...
Qnn_ErrorHandle_t MatMulCustomOpPackageGetInfo(const QnnOpPackage_Info_t** info) {
...
Qnn_ErrorHandle_t MatMulCustomOpPackageLogInitialize(QnnLog_Callback_t callback, QnnLog_Level_t maxLogLevel) {
...
Qnn_ErrorHandle_t MatMulCustomOpPackageLogSetLevel(QnnLog_Level_t maxLogLevel) {
    if (maxLogLevel < QNN_LOG_LEVEL_ERROR) return QNN_LOG_ERROR_INVALID_ARGUMENT;
    sg_maxLogLevel = maxLogLevel;
    return QNN_SUCCESS;
}

Qnn_ErrorHandle_t MatMulCustomOpPackageLogTerminate() {
...
Qnn_ErrorHandle_t MatMulCustomOpPackageValidateOpConfig (Qnn_OpConfig_t opConfig){
 ...
 * (version 1.3.0) Qnn_ErrorHandle_t MatMulCustomOpPackageCreateKernels (QnnOpPackage_GraphInfrastructure_t
 * graphInfrastructure, QnnOpPackage_Node_t node, QnnOpPackage_Kernel_t** kernels, uint32_t*
 * numKernels)
 * (version 1.3.0) Qnn_ErrorHandle_t MatMulCustomOpPackageFreeKernels (QnnOpPackage_Kernel_t* kernels)
 *
 * (version 1.4.0) Qnn_ErrorHandle_t MatMulCustomOpPackageCreateOpImpl (QnnOpPackage_GraphInfrastructure_t
 * graphInfrastructure, QnnOpPackage_Node_t node, QnnOpPackage_OpImpl_t* opImpl)
 *(version 1.4.0) Qnn_ErrorHandle_t MatMulCustomOpPackageFreeOpImpl (QnnOpPackage_OpImpl_t opImpl)
 */

Qnn_ErrorHandle_t MatMulCustomOpPackageTerminate() {
if (!sg_packageInitialized) return QNN_OP_PACKAGE_ERROR_LIBRARY_NOT_INITIALIZED;
...
/* latest version */
Qnn_ErrorHandle_t MatMulCustomOpPackageInterfaceProvider(QnnOpPackage_Interface_t* interface) {
  if (!interface) return QNN_OP_PACKAGE_ERROR_INVALID_ARGUMENT;
  interface->interfaceVersion      = {1, 4, 0};
  interface->v1_4.init             = MatMulCustomOpPackageInit;
  interface->v1_4.terminate        = MatMulCustomOpPackageTerminate;
  interface->v1_4.getInfo          = MatMulCustomOpPackageGetInfo;
  interface->v1_4.validateOpConfig = MatMulCustomOpPackageValidateOpConfig;
  interface->v1_4.createOpImpl     = nullptr;
  interface->v1_4.freeOpImpl       = nullptr;
  interface->v1_4.logInitialize    = MatMulCustomOpPackageLogInitialize;
  interface->v1_4.logSetLevel      = MatMulCustomOpPackageLogSetLevel;
  interface->v1_4.logTerminate     = MatMulCustomOpPackageLogTerminate;
  return QNN_SUCCESS;
}
