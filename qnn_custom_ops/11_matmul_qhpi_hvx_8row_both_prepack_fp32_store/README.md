...
本目录基于 `../10_matmul_qhpi_hvx_8row_lhs_prepack_fp32_store`，同时预转换
LHS 和 RHS。
...
```bash
PKG=qnn_custom_ops/11_matmul_qhpi_hvx_8row_both_prepack_fp32_store/htp/MatMulQhpiHvx8RowBothPrepackFp32StoreOpPackage
...
/home/lingbok/Qualcomm/qairt/2.47.0.260601/bin/x86_64-linux-clang/qnn-model-lib-generator \
  -c qnn_custom_ops/11_matmul_qhpi_hvx_8row_both_prepack_fp32_store/model/custom_matmul_qhpi_hvx_8row_both_prepack_fp32_store_model.cpp \
  -t aarch64-android \
  -l custom_matmul_qhpi_hvx_8row_both_prepack_fp32_store_model \
  -o qnn_custom_ops/11_matmul_qhpi_hvx_8row_both_prepack_fp32_store/model_libs
```
