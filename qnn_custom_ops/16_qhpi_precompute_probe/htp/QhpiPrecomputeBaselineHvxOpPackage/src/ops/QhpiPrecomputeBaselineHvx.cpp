...
static QHPI_Kernel_v1 kernel = {
    .function_name = "qhpi_precompute_probe_baseline",
...
QHPI_OpInfo_v1 qhpiprecomputebaselinehvxOpInfo = {
    .name = THIS_PKG_NAME_STR "::QhpiPrecomputeBaselineHvx",
    .num_kernels = 1,
    .kernels = kernels,
...
static QHPI_OpInfo_v1 ops[] = {qhpiprecomputebaselinehvxOpInfo};

extern "C" void register_qhpiprecomputebaselinehvx_ops() {
