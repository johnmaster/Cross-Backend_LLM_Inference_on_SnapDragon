//==============================================================================
// Auto Generated Code for QhpiPrecomputeBaselineHvxOpPackage - QHPI Interface
//==============================================================================
...
// Forward declaration for QhpiPrecomputeBaselineHvx registration
extern void register_qhpiprecomputebaselinehvx_ops();

// External declarations for operator infos from individual operator files
extern QHPI_OpInfo_v1 qhpiprecomputebaselinehvxOpInfo;

// op package info
const char* const sg_packageName = "QhpiPrecomputeBaselineHvxOpPackage";  // package name passed in as compile flag

static std::array<const char*, 1> sg_opNames{{"QhpiPrecomputeBaselineHvx"}};
 ...
 * can be set by Qnn_ErrorHandle_t QhpiPrecomputeBaselineHvxOpPackageLogSetLevel(QnnLog_Level_t maxLogLevel)
 */
/*
...
Qnn_ErrorHandle_t QhpiPrecomputeBaselineHvxOpPackageInit(QnnOpPackage_GlobalInfrastructure_t infrastructure) {
...
Qnn_ErrorHandle_t QhpiPrecomputeBaselineHvxOpPackageGetInfo(const QnnOpPackage_Info_t** info) {
...
Qnn_ErrorHandle_t QhpiPrecomputeBaselineHvxOpPackageLogInitialize(QnnLog_Callback_t callback, QnnLog_Level_t maxLogLevel) {
...
Qnn_ErrorHandle_t QhpiPrecomputeBaselineHvxOpPackageLogSetLevel(QnnLog_Level_t maxLogLevel) {
    if (maxLogLevel < QNN_LOG_LEVEL_ERROR) return QNN_LOG_ERROR_INVALID_ARGUMENT;
    sg_maxLogLevel = maxLogLevel;
    return QNN_SUCCESS;
}

Qnn_ErrorHandle_t QhpiPrecomputeBaselineHvxOpPackageLogTerminate() {
...
Qnn_ErrorHandle_t QhpiPrecomputeBaselineHvxOpPackageValidateOpConfig (Qnn_OpConfig_t opConfig){
     ...
     */
    if (std::string(opConfig.v1.typeName) == "QhpiPrecomputeBaselineHvx"){
 ...
 * (version 1.3.0) Qnn_ErrorHandle_t QhpiPrecomputeBaselineHvxOpPackageCreateKernels (QnnOpPackage_GraphInfrastructure_t
 * graphInfrastructure, QnnOpPackage_Node_t node, QnnOpPackage_Kernel_t** kernels, uint32_t*
 * numKernels)
 * (version 1.3.0) Qnn_ErrorHandle_t QhpiPrecomputeBaselineHvxOpPackageFreeKernels (QnnOpPackage_Kernel_t* kernels)
 *
 * (version 1.4.0) Qnn_ErrorHandle_t QhpiPrecomputeBaselineHvxOpPackageCreateOpImpl (QnnOpPackage_GraphInfrastructure_t
 * graphInfrastructure, QnnOpPackage_Node_t node, QnnOpPackage_OpImpl_t* opImpl)
 *(version 1.4.0) Qnn_ErrorHandle_t QhpiPrecomputeBaselineHvxOpPackageFreeOpImpl (QnnOpPackage_OpImpl_t opImpl)
 */

Qnn_ErrorHandle_t QhpiPrecomputeBaselineHvxOpPackageTerminate() {
if (!sg_packageInitialized) return QNN_OP_PACKAGE_ERROR_LIBRARY_NOT_INITIALIZED;
...
/* latest version */
Qnn_ErrorHandle_t QhpiPrecomputeBaselineHvxOpPackageInterfaceProvider(QnnOpPackage_Interface_t* interface) {
  if (!interface) return QNN_OP_PACKAGE_ERROR_INVALID_ARGUMENT;
  interface->interfaceVersion      = {1, 4, 0};
  interface->v1_4.init             = QhpiPrecomputeBaselineHvxOpPackageInit;
  interface->v1_4.terminate        = QhpiPrecomputeBaselineHvxOpPackageTerminate;
  interface->v1_4.getInfo          = QhpiPrecomputeBaselineHvxOpPackageGetInfo;
  interface->v1_4.validateOpConfig = QhpiPrecomputeBaselineHvxOpPackageValidateOpConfig;
  interface->v1_4.createOpImpl     = nullptr;
  interface->v1_4.freeOpImpl       = nullptr;
  interface->v1_4.logInitialize    = QhpiPrecomputeBaselineHvxOpPackageLogInitialize;
  interface->v1_4.logSetLevel      = QhpiPrecomputeBaselineHvxOpPackageLogSetLevel;
  interface->v1_4.logTerminate     = QhpiPrecomputeBaselineHvxOpPackageLogTerminate;
  return QNN_SUCCESS;
}

// Implementation of qhpi_init function
const char* qhpi_init() {
    register_qhpiprecomputebaselinehvx_ops();
