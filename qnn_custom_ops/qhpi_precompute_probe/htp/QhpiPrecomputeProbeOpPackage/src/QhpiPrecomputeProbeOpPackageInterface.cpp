//==============================================================================
// Auto Generated Code for QhpiPrecomputeProbeOpPackage - QHPI Interface
//==============================================================================
...
// Forward declaration for QhpiPrecomputeProbe registration
extern void register_qhpiprecomputeprobe_ops();

// External declarations for operator infos from individual operator files
extern QHPI_OpInfo_v1 qhpiprecomputeprobeOpInfo;

// op package info
const char* const sg_packageName = "QhpiPrecomputeProbeOpPackage";  // package name passed in as compile flag

static std::array<const char*, 1> sg_opNames{{"QhpiPrecomputeProbe"}};
 ...
 * can be set by Qnn_ErrorHandle_t QhpiPrecomputeProbeOpPackageLogSetLevel(QnnLog_Level_t maxLogLevel)
 */
/*
...
Qnn_ErrorHandle_t QhpiPrecomputeProbeOpPackageInit(QnnOpPackage_GlobalInfrastructure_t infrastructure) {
...
Qnn_ErrorHandle_t QhpiPrecomputeProbeOpPackageGetInfo(const QnnOpPackage_Info_t** info) {
...
Qnn_ErrorHandle_t QhpiPrecomputeProbeOpPackageLogInitialize(QnnLog_Callback_t callback, QnnLog_Level_t maxLogLevel) {
...
Qnn_ErrorHandle_t QhpiPrecomputeProbeOpPackageLogSetLevel(QnnLog_Level_t maxLogLevel) {
    if (maxLogLevel < QNN_LOG_LEVEL_ERROR) return QNN_LOG_ERROR_INVALID_ARGUMENT;
    sg_maxLogLevel = maxLogLevel;
    return QNN_SUCCESS;
}

Qnn_ErrorHandle_t QhpiPrecomputeProbeOpPackageLogTerminate() {
...
Qnn_ErrorHandle_t QhpiPrecomputeProbeOpPackageValidateOpConfig (Qnn_OpConfig_t opConfig){
     ...
     */
    if (std::string(opConfig.v1.typeName) == "QhpiPrecomputeProbe"){
 ...
 * (version 1.3.0) Qnn_ErrorHandle_t QhpiPrecomputeProbeOpPackageCreateKernels (QnnOpPackage_GraphInfrastructure_t
 * graphInfrastructure, QnnOpPackage_Node_t node, QnnOpPackage_Kernel_t** kernels, uint32_t*
 * numKernels)
 * (version 1.3.0) Qnn_ErrorHandle_t QhpiPrecomputeProbeOpPackageFreeKernels (QnnOpPackage_Kernel_t* kernels)
 *
 * (version 1.4.0) Qnn_ErrorHandle_t QhpiPrecomputeProbeOpPackageCreateOpImpl (QnnOpPackage_GraphInfrastructure_t
 * graphInfrastructure, QnnOpPackage_Node_t node, QnnOpPackage_OpImpl_t* opImpl)
 *(version 1.4.0) Qnn_ErrorHandle_t QhpiPrecomputeProbeOpPackageFreeOpImpl (QnnOpPackage_OpImpl_t opImpl)
 */

Qnn_ErrorHandle_t QhpiPrecomputeProbeOpPackageTerminate() {
if (!sg_packageInitialized) return QNN_OP_PACKAGE_ERROR_LIBRARY_NOT_INITIALIZED;
...
/* latest version */
Qnn_ErrorHandle_t QhpiPrecomputeProbeOpPackageInterfaceProvider(QnnOpPackage_Interface_t* interface) {
  if (!interface) return QNN_OP_PACKAGE_ERROR_INVALID_ARGUMENT;
  interface->interfaceVersion      = {1, 4, 0};
  interface->v1_4.init             = QhpiPrecomputeProbeOpPackageInit;
  interface->v1_4.terminate        = QhpiPrecomputeProbeOpPackageTerminate;
  interface->v1_4.getInfo          = QhpiPrecomputeProbeOpPackageGetInfo;
  interface->v1_4.validateOpConfig = QhpiPrecomputeProbeOpPackageValidateOpConfig;
  interface->v1_4.createOpImpl     = nullptr;
  interface->v1_4.freeOpImpl       = nullptr;
  interface->v1_4.logInitialize    = QhpiPrecomputeProbeOpPackageLogInitialize;
  interface->v1_4.logSetLevel      = QhpiPrecomputeProbeOpPackageLogSetLevel;
  interface->v1_4.logTerminate     = QhpiPrecomputeProbeOpPackageLogTerminate;
  return QNN_SUCCESS;
}

// Implementation of qhpi_init function
const char* qhpi_init() {
    register_qhpiprecomputeprobe_ops();
