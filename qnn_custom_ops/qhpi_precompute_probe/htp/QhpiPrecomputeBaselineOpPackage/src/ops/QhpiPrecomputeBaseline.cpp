...
QHPI_OpInfo_v1 qhpiprecomputebaselineOpInfo = {
    .name = THIS_PKG_NAME_STR "::QhpiPrecomputeBaseline",
    .num_kernels = 1,
    .kernels = kernels,
...
static QHPI_OpInfo_v1 ops[] = {qhpiprecomputebaselineOpInfo};

extern "C" void register_qhpiprecomputebaseline_ops() {
