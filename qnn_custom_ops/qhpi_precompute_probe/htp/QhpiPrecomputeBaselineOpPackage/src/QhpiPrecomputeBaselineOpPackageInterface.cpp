//==============================================================================
// Auto Generated Code for QhpiPrecomputeBaselineOpPackage - QHPI Interface
//==============================================================================
...
// Forward declaration for QhpiPrecomputeBaseline registration
extern void register_qhpiprecomputebaseline_ops();

// External declarations for operator infos from individual operator files
extern QHPI_OpInfo_v1 qhpiprecomputebaselineOpInfo;

// op package info
const char* const sg_packageName = "QhpiPrecomputeBaselineOpPackage";  // package name passed in as compile flag

static std::array<const char*, 1> sg_opNames{{"QhpiPrecomputeBaseline"}};
 ...
 * can be set by Qnn_ErrorHandle_t QhpiPrecomputeBaselineOpPackageLogSetLevel(QnnLog_Level_t maxLogLevel)
 */
/*
...
Qnn_ErrorHandle_t QhpiPrecomputeBaselineOpPackageInit(QnnOpPackage_GlobalInfrastructure_t infrastructure) {
...
Qnn_ErrorHandle_t QhpiPrecomputeBaselineOpPackageGetInfo(const QnnOpPackage_Info_t** info) {
...
Qnn_ErrorHandle_t QhpiPrecomputeBaselineOpPackageLogInitialize(QnnLog_Callback_t callback, QnnLog_Level_t maxLogLevel) {
...
Qnn_ErrorHandle_t QhpiPrecomputeBaselineOpPackageLogSetLevel(QnnLog_Level_t maxLogLevel) {
    if (maxLogLevel < QNN_LOG_LEVEL_ERROR) return QNN_LOG_ERROR_INVALID_ARGUMENT;
    sg_maxLogLevel = maxLogLevel;
    return QNN_SUCCESS;
}

Qnn_ErrorHandle_t QhpiPrecomputeBaselineOpPackageLogTerminate() {
...
Qnn_ErrorHandle_t QhpiPrecomputeBaselineOpPackageValidateOpConfig (Qnn_OpConfig_t opConfig){
     ...
     */
    if (std::string(opConfig.v1.typeName) == "QhpiPrecomputeBaseline"){
 ...
 * (version 1.3.0) Qnn_ErrorHandle_t QhpiPrecomputeBaselineOpPackageCreateKernels (QnnOpPackage_GraphInfrastructure_t
 * graphInfrastructure, QnnOpPackage_Node_t node, QnnOpPackage_Kernel_t** kernels, uint32_t*
 * numKernels)
 * (version 1.3.0) Qnn_ErrorHandle_t QhpiPrecomputeBaselineOpPackageFreeKernels (QnnOpPackage_Kernel_t* kernels)
 *
 * (version 1.4.0) Qnn_ErrorHandle_t QhpiPrecomputeBaselineOpPackageCreateOpImpl (QnnOpPackage_GraphInfrastructure_t
 * graphInfrastructure, QnnOpPackage_Node_t node, QnnOpPackage_OpImpl_t* opImpl)
 *(version 1.4.0) Qnn_ErrorHandle_t QhpiPrecomputeBaselineOpPackageFreeOpImpl (QnnOpPackage_OpImpl_t opImpl)
 */

Qnn_ErrorHandle_t QhpiPrecomputeBaselineOpPackageTerminate() {
if (!sg_packageInitialized) return QNN_OP_PACKAGE_ERROR_LIBRARY_NOT_INITIALIZED;
...
/* latest version */
Qnn_ErrorHandle_t QhpiPrecomputeBaselineOpPackageInterfaceProvider(QnnOpPackage_Interface_t* interface) {
  if (!interface) return QNN_OP_PACKAGE_ERROR_INVALID_ARGUMENT;
  interface->interfaceVersion      = {1, 4, 0};
  interface->v1_4.init             = QhpiPrecomputeBaselineOpPackageInit;
  interface->v1_4.terminate        = QhpiPrecomputeBaselineOpPackageTerminate;
  interface->v1_4.getInfo          = QhpiPrecomputeBaselineOpPackageGetInfo;
  interface->v1_4.validateOpConfig = QhpiPrecomputeBaselineOpPackageValidateOpConfig;
  interface->v1_4.createOpImpl     = nullptr;
  interface->v1_4.freeOpImpl       = nullptr;
  interface->v1_4.logInitialize    = QhpiPrecomputeBaselineOpPackageLogInitialize;
  interface->v1_4.logSetLevel      = QhpiPrecomputeBaselineOpPackageLogSetLevel;
  interface->v1_4.logTerminate     = QhpiPrecomputeBaselineOpPackageLogTerminate;
  return QNN_SUCCESS;
}

// Implementation of qhpi_init function
const char* qhpi_init() {
    register_qhpiprecomputebaseline_ops();
